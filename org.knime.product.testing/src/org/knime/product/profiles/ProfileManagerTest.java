...
public class ProfileManagerTest {
    ...
    public void testAppliedPreferences() throws Exception {
        // This test assume that certain profiles have been supplied on the command line.
        List<String> args = Arrays.asList(Platform.getCommandLineArgs());
        assumeThat("No profile arguments provided on command line", args, hasItems("-profileLocation", "-profileList"));
