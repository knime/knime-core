 ...
 *
 * History
 *   23 Mar 2022 (Marc Bux, KNIME GmbH, Berlin, Germany): created
 */
 ...
 * {@link RuntimeException} would be handled as an internal error by the framework, a {@link DataServiceException} is
...
public final class DataServiceException extends RuntimeException {
     ...
     */
    public DataServiceException(final String message, final Throwable cause) {
     ...
     * @param cause the throwable causing this exception
     */
    public DataServiceException(final String message, final String details, final Throwable cause) {
        super(message, cause);
        m_details = details;
    }

    /**
     * @return the message providing further details about this exception
     */
