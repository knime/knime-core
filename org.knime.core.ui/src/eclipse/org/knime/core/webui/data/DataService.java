...
/**
 * Responsible for the data exchange (request-response model) between the core logic (e.g. node model or port object)
 * and the respective UI extension (such as node view, node dialog or port view).
 *
...
public interface DataService {
    ...
    /**
     * @param in the data being received
