...
public class SingleInteractiveWebViewResultWrapper<T extends ViewableModel & WizardNode<REP, VAL>, REP extends WebViewContent, VAL extends WebViewContent>
    extends AbstractWrapper<SingleInteractiveWebViewResult> implements SingleInteractiveWebViewResultUI<T, REP, VAL> {

    /**
     * @param delegate the implementation to delegate to
     */
    protected SingleInteractiveWebViewResultWrapper(final SingleInteractiveWebViewResult delegate) {
        super(delegate);
    }
