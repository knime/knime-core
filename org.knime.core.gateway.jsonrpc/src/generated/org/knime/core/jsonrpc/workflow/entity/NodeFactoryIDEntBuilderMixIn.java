...
@JsonTypeInfo(
    ...
    defaultImpl = DefaultNodeFactoryIDEntBuilder.class)
@JsonSubTypes({
    @Type(value = DefaultNodeFactoryIDEntBuilder.class, name="NodeFactoryIDEnt")
})
// AUTO-GENERATED CODE; DO NOT MODIFY
public interface NodeFactoryIDEntBuilderMixIn extends NodeFactoryIDEntBuilder {
