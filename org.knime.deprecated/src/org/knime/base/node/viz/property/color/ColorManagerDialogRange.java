 ...
 */
public class ColorManagerDialogRange extends JPanel {
    ...
    private final ColorManagerRangeIcon m_rangeLabel;

    /**
     * Creates a new empty dialog pane.
     */
    ColorManagerDialogRange() {
        super(new BorderLayout());
        m_rangeLabel = new ColorManagerRangeIcon();
    ...
    void update(final String column, final Color color) {
        ...
        if (idx == 0 || idx == 1) {
            ColorManagerIcon icon = (ColorManagerIcon)m_columnValues
                    .getSelectedValue();
            icon.setColor(color);
    ...
    boolean select(final String column) {
        ...
        if (o == null) {
            ...
            m_columnModel.addElement(new ColorManagerIcon(e[0].getCell(),
                    "min=", e[0].getColor()));
            m_rangeLabel.setMinColor(e[0].getColor());
            m_columnModel.addElement(new ColorManagerIcon(e[1].getCell(),
                    "max=", e[1].getColor()));
