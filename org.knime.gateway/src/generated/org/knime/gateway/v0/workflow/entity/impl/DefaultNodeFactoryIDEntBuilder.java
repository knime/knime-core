...
/**
 * Default implementation of the NodeFactoryIDEntBuilder-interface. E.g. used if no other {@link EntityBuilderFactory}
 * implementation (provided via the respective extension point, see {@link EntityBuilderManager}) is available.
 *
 * @author Martin Horn, University of Konstanz
 */
 public class DefaultNodeFactoryIDEntBuilder implements NodeFactoryIDEntBuilder {
    
	String m_ClassName;
	Optional<String> m_NodeName = Optional.empty();
