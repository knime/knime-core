...
import org.knime.core.gateway.codegen.MyResourceLoader;
import org.knime.core.gateway.codegen.SourceCodeGenerator;

/**
 * Generates the 'EntityDefUtil' from entity definitions.
 *
 * @author Martin Horn, University of Konstanz
 */
public class EntityDefUtilGenerator extends SourceCodeGenerator {

    private final static String DEF_UTIL_TEMPLATE = "EntityDefUtil";

    private Collection<EntityDef> m_entityDefs;
     ...
     *
     */
    public EntityDefUtilGenerator(final Collection<EntityDef> entityDefs, final String outputDir, final String defaultPackage) {
    ...
    public void generate() {
        ...
        try {
            ...
            context.put("entityDefs", m_entityDefs);
