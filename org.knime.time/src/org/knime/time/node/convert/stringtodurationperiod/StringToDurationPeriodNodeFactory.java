...
/**
 * The node factory of the node which converts string cells to period or duration cells.
 *
...
public class StringToDurationPeriodNodeFactory extends NodeFactory<StringToDurationPeriodNodeModel>{
     ...
     */
    @Override
    public NodeView<StringToDurationPeriodNodeModel> createNodeView(final int viewIndex,
        final StringToDurationPeriodNodeModel nodeModel) {
        return null;
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new StringToDurationPeriodNodeDialog();
    }
