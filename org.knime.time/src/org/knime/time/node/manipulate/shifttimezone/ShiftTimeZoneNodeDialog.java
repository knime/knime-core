 ...
 */
class ShiftTimeZoneNodeDialog extends NodeDialogPane {
    ...
    public static SettingsModelString createReplaceAppendStringBool() {
        return new SettingsModelString("replace_or_append", ShiftTimeZoneNodeDialog.OPTION_REPLACE);
    }

    /** @return the string model, used in both dialog and model. */
    public static SettingsModelString createSuffixModel() {
        SettingsModelString settingsModelString = new SettingsModelString("suffix", "(shifted time zone)");
