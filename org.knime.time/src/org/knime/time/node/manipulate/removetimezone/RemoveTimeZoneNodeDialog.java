...
/**
 * The node dialog of the node which removes the time zone.
 *
 * @author Simon Schmid, KNIME.com, Konstanz, Germany
 */
class RemoveTimeZoneNodeDialog extends NodeDialogPane {
    ...
    public static SettingsModelColumnFilter2 createColSelectModel() {
        return new SettingsModelColumnFilter2("col_select", ZonedDateTimeValue.class);
    }

    /** @return the string model, used in both dialog and model. */
    public static SettingsModelString createReplaceAppendStringBool() {
        return new SettingsModelString("replace_or_append", RemoveTimeZoneNodeDialog.OPTION_REPLACE);
    }

    /** @return the string model, used in both dialog and model. */
    public static SettingsModelString createSuffixModel() {
        SettingsModelString settingsModelString = new SettingsModelString("suffix", "(without time zone)");
