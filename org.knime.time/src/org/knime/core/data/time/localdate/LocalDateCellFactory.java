...
/**
 * Factory for creating {@link LocalDateCell}.
 *
 * @author Simon Schmid, KNIME.com, Konstanz, Germany
 * @since 3.3
 */
public final class LocalDateCellFactory implements FromSimpleString, FromComplexString {
    /**
     * The data type for the cells created by this factory.
     */
    public static final DataType TYPE = LocalDateCell.TYPE;
    ...
    /**
     * Creates a new LocalDateCell from a string such as "2016-10-05".
     * For details see {@link LocalDate#parse(CharSequence)}.
     * @param s the string to parse into {@link LocalDateCell}, not null.
     * @return the cell containing the parsed LocalDate.
     * @throws IllegalArgumentException when the string is null.
     * @throws DateTimeParseException as per {@link LocalDate#parse(CharSequence)}
     */
    public static DataCell create(final String s) {
        return create(LocalDate.parse(CheckUtils.checkArgumentNotNull(s, "Argument must not be null")));
    }

    /**
     * Creates a new LocalDateCell from the arguments, see {@link LocalDate#parse(CharSequence, DateTimeFormatter)}.
     ...
     * @throws DateTimeParseException as per {@link LocalDate#parse(CharSequence, DateTimeFormatter)}
    ...
    /**
     * Creates a new LocalDateCell from the argument.
     * @param localDate Non-null argument to wrap.
     * @return the cell containing the parsed LocalDate.
