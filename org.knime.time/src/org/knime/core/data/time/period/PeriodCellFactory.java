 ...
 * @since 3.3
 */
public final class PeriodCellFactory implements FromSimpleString, FromComplexString {
    /**
     * The data type for the cells created by this factory.
     */
    public static final DataType TYPE = PeriodCell.TYPE;
    ...
    /**
     * Creates a new PeriodCell from a string such as "PT20.345S".
     * For details see {@link Period#parse(CharSequence)}.
     * @param s the string to parse into {@link PeriodCell}, not null.
    ...
    /**
     * Creates a new PeriodCell from the argument.
     * @param period Non-null argument to wrap.
     * @return the cell containing the parsed Period.
