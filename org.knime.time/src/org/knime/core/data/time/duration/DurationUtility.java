...
/**
 * The {@link UtilityFactory} for the {@link DurationValue}.
 * @since 3.3
 * @noreference This class is not intended to be referenced by clients.
 * @author Simon Schmid, KNIME.com, Konstanz, Germany
 */
public final class DurationUtility extends ExtensibleUtilityFactory {

    /** Singleton icon to be used to display this cell type. */
    private static final Icon ICON = loadIcon(DurationUtility.class, "date_time.png");

    private static final DataValueComparator COMPARATOR = new DurationComparator();
