 ...
 */
public class TNativeNodeEntFromThrift implements NativeNodeEnt {

	private final TNativeNodeEnt m_e;

	public TNativeNodeEntFromThrift(final TNativeNodeEnt e) {
		m_e = e;
	}

    @Override
    public NodeFactoryIDEnt getNodeFactoryID() {
    	        return new TNodeFactoryIDEntFromThrift(m_e.getNodeFactoryID());
            }
    ...
    public static class TNativeNodeEntBuilderFromThrift implements NativeNodeEntBuilder {
		...
		public TNativeNodeEntBuilderFromThrift(final TNativeNodeEntBuilder b) {
			m_b = b;
		}
	
        public NativeNodeEnt build() {
            return new TNativeNodeEntFromThrift(m_b.build());
        }

		@Override
        public TNativeNodeEntBuilderFromThrift setNodeFactoryID(final NodeFactoryIDEnt NodeFactoryID) {
                	m_b.setNodeFactoryID(new TNodeFactoryIDEntToThrift(NodeFactoryID));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setParent(final EntityID Parent) {
                	m_b.setParent(new TEntityIDToThrift(Parent));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setJobManager(final JobManagerEnt JobManager) {
                	m_b.setJobManager(new TJobManagerEntToThrift(JobManager));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setNodeMessage(final NodeMessageEnt NodeMessage) {
                	m_b.setNodeMessage(new TNodeMessageEntToThrift(NodeMessage));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setInPorts(final List<NodeInPortEnt> InPorts) {
                	m_b.setInPorts(InPorts.stream().map(e -> new TNodeInPortEntToThrift(e)).collect(Collectors.toList()));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setOutPorts(final List<NodeOutPortEnt> OutPorts) {
                	m_b.setOutPorts(OutPorts.stream().map(e -> new TNodeOutPortEntToThrift(e)).collect(Collectors.toList()));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setName(final String Name) {
                	m_b.setName(Name);
                    return this;
        }
		...
		@Override
        public TNativeNodeEntBuilderFromThrift setNodeType(final String NodeType) {
                	m_b.setNodeType(NodeType);
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setBounds(final BoundsEnt Bounds) {
                	m_b.setBounds(new TBoundsEntToThrift(Bounds));
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setIsDeletable(final boolean IsDeletable) {
                	m_b.setIsDeletable(IsDeletable);
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setNodeState(final String NodeState) {
                	m_b.setNodeState(NodeState);
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setHasDialog(final boolean HasDialog) {
                	m_b.setHasDialog(HasDialog);
                    return this;
        }
        
		@Override
        public TNativeNodeEntBuilderFromThrift setNodeAnnotation(final NodeAnnotationEnt NodeAnnotation) {
