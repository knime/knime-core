 ...
 */
public class WorkflowCoachDragSource implements DragSourceListener {

    private WorkflowCoachView m_view;

    /**
     *
     * @param view the view
     */
    public WorkflowCoachDragSource(final WorkflowCoachView view) {
        m_view = view;
