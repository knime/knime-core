...
/**
 * RESTful service implementation of the {@link RSExecutionService}-rest calls (i.e. rest resources) that delegates the calls
 * to the wrapped service.
 *
 * @author Martin Horn, University of Konstanz
 */
// AUTO-GENERATED CODE; DO NOT MODIFY
public class RSWrapperExecutionService implements RSExecutionService {

    private ExecutionService m_service;
    
    public RSWrapperExecutionService(ExecutionService service) {
    	m_service = service;
    }
