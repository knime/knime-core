...
/**
 * RESTful service implementation of the {@link RSRepositoryService}-rest calls (i.e. rest resources) that delegates the calls
...
public class RSWrapperRepositoryService implements RSRepositoryService {
    ...
    public RSWrapperRepositoryService(RepositoryService service) {
    	m_service = service;
    }
