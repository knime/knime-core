...
/**
 * Maps api gateway services to the rest service wrappers.
 *
 * @author Martin Horn, University of Konstanz
 */
public class RSWrapperServiceMap extends ServiceMap<Class<GatewayService>> {
     ...
     */
    public static RSWrapperServiceMap getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new RSWrapperServiceMap();
        }
        return INSTANCE;
    }
