...
import org.knime.core.thrift.workflow.service.TWorkflowServiceImpl;
...
public class TestClientServer {
    ...
    public static void main(final String[] args) throws InterruptedException, ExecutionException {
        ThriftServiceProcessor thriftServiceProcessor =
            new ThriftServiceProcessor(new ThriftCodecManager(), Collections.EMPTY_LIST, new TWorkflowServiceImpl());
        ...
        TWorkflowService wfService = clientManager.createClient(connector, TWorkflowService.class).get();
        wfService.updateWorkflow(new TWorkflow());
