...
import org.knime.core.thrift.workflow.service.DefaultTWorkflowService;
...
public class ThriftPlugin implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        ThriftServiceProcessor thriftServiceProcessor =
            new ThriftServiceProcessor(new ThriftCodecManager(), Collections.EMPTY_LIST, new DefaultTWorkflowService());
