 ...
 */
public class TBoundsEntToThrift extends TBoundsEnt {

	private final BoundsEnt m_e;
	
	public TBoundsEntToThrift(final BoundsEnt e) {
		m_e = e;
	}
    ...
    public static class TBoundsEntBuilderToThrift extends TBoundsEntBuilder {
    	...
    	public TBoundsEntBuilderToThrift(final BoundsEntBuilder b) {
    		m_b = b;
    	}
        ...
        public TBoundsEnt build() {
            return new TBoundsEntToThrift(m_b.build());
        }
		...
		@Override
        public TBoundsEntBuilderToThrift setX(final int X) {
					m_b.setX(X);
		            return this;
        }
        
		@Override
        public TBoundsEntBuilderToThrift setY(final int Y) {
					m_b.setY(Y);
		            return this;
        }
        
		@Override
        public TBoundsEntBuilderToThrift setWidth(final int Width) {
					m_b.setWidth(Width);
		            return this;
        }
        
		@Override
        public TBoundsEntBuilderToThrift setHeight(final int Height) {
