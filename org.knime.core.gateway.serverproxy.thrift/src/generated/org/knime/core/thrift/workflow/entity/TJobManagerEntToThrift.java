 ...
 */
public class TJobManagerEntToThrift extends TJobManagerEnt {

	private final JobManagerEnt m_e;
	
	public TJobManagerEntToThrift(final JobManagerEnt e) {
		m_e = e;
	}
    ...
    public static class TJobManagerEntBuilderToThrift extends TJobManagerEntBuilder {
    	...
    	public TJobManagerEntBuilderToThrift(final JobManagerEntBuilder b) {
    		m_b = b;
    	}
        ...
        public TJobManagerEnt build() {
            return new TJobManagerEntToThrift(m_b.build());
        }
		...
		@Override
        public TJobManagerEntBuilderToThrift setName(final String Name) {
					m_b.setName(Name);
		            return this;
        }
        
		@Override
        public TJobManagerEntBuilderToThrift setJobManagerID(final String JobManagerID) {
