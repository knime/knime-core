 ...
 */
public class TNodeOutPortEntFromThrift implements NodeOutPortEnt {

	private final TNodeOutPortEnt m_e;

	public TNodeOutPortEntFromThrift(final TNodeOutPortEnt e) {
		m_e = e;
	}
    ...
    public static class TNodeOutPortEntBuilderFromThrift implements NodeOutPortEntBuilder {
		...
		public TNodeOutPortEntBuilderFromThrift(final TNodeOutPortEntBuilder b) {
			m_b = b;
		}
	
        public NodeOutPortEnt build() {
            return new TNodeOutPortEntFromThrift(m_b.build());
        }

		@Override
        public TNodeOutPortEntBuilderFromThrift setPortIndex(final int PortIndex) {
                	m_b.setPortIndex(PortIndex);
                    return this;
        }
        
		@Override
        public TNodeOutPortEntBuilderFromThrift setPortType(final PortTypeEnt PortType) {
                	m_b.setPortType(new TPortTypeEntToThrift(PortType));
                    return this;
        }
        
		@Override
        public TNodeOutPortEntBuilderFromThrift setPortName(final String PortName) {
