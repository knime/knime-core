 ...
 */
public class TEntityIDToThrift extends TEntityID {

	private final EntityID m_e;
	
	public TEntityIDToThrift(final EntityID e) {
		m_e = e;
	}
    ...
    public static class TEntityIDBuilderToThrift extends TEntityIDBuilder {
    	...
    	public TEntityIDBuilderToThrift(final EntityIDBuilder b) {
    		m_b = b;
    	}
        ...
        public TEntityID build() {
            return new TEntityIDToThrift(m_b.build());
        }
		...
		@Override
        public TEntityIDBuilderToThrift setID(final String ID) {
					m_b.setID(ID);
		            return this;
        }
        
		@Override
        public TEntityIDBuilderToThrift setType(final String Type) {
					m_b.setType(Type);
		            return this;
        }
