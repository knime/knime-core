 ...
 */
public class TNodeInPortEntFromThrift implements NodeInPortEnt {

	private final TNodeInPortEnt m_e;

	public TNodeInPortEntFromThrift(final TNodeInPortEnt e) {
		m_e = e;
	}
    ...
    public static class TNodeInPortEntBuilderFromThrift implements NodeInPortEntBuilder {
		...
		public TNodeInPortEntBuilderFromThrift(final TNodeInPortEntBuilder b) {
			m_b = b;
		}
	
        public NodeInPortEnt build() {
            return new TNodeInPortEntFromThrift(m_b.build());
        }

		@Override
        public TNodeInPortEntBuilderFromThrift setPortIndex(final int PortIndex) {
                	m_b.setPortIndex(PortIndex);
                    return this;
        }
        
		@Override
        public TNodeInPortEntBuilderFromThrift setPortType(final PortTypeEnt PortType) {
                	m_b.setPortType(new TPortTypeEntToThrift(PortType));
                    return this;
        }
        
		@Override
        public TNodeInPortEntBuilderFromThrift setPortName(final String PortName) {
