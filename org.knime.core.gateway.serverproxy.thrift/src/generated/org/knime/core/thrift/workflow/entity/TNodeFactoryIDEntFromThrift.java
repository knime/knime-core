 ...
 */
public class TNodeFactoryIDEntFromThrift implements NodeFactoryIDEnt {

	private final TNodeFactoryIDEnt m_e;

	public TNodeFactoryIDEntFromThrift(final TNodeFactoryIDEnt e) {
		m_e = e;
	}
    ...
    public static class TNodeFactoryIDEntBuilderFromThrift implements NodeFactoryIDEntBuilder {
		...
		public TNodeFactoryIDEntBuilderFromThrift(final TNodeFactoryIDEntBuilder b) {
			m_b = b;
		}
	
        public NodeFactoryIDEnt build() {
            return new TNodeFactoryIDEntFromThrift(m_b.build());
        }

		@Override
        public TNodeFactoryIDEntBuilderFromThrift setClassName(final String ClassName) {
                	m_b.setClassName(ClassName);
                    return this;
        }
        
		@Override
        public TNodeFactoryIDEntBuilderFromThrift setNodeName(final String NodeName) {
