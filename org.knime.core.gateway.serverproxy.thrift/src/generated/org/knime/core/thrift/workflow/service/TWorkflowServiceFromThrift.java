...
public class TWorkflowServiceFromThrift implements TWorkflowService {
	...
	@Override
 	public TWorkflowEnt TgetWorkflow(final TEntityID id) {
   	 	 	  		return new TWorkflowEntToThrift(m_service.getWorkflow(new TEntityIDFromThrift(id)));
  	}
	
	@Override
 	public void TupdateWorkflow(final TWorkflowEnt wf) {
   	 	 	   		m_service.updateWorkflow(new TWorkflowEntFromThrift(wf));
  	}
	
	@Override
 	public List<TEntityID> TgetAllWorkflows() {
    		return m_service.getAllWorkflows().stream().map(e -> new TEntityIDToThrift(e)).collect(Collectors.toList());
  	}
