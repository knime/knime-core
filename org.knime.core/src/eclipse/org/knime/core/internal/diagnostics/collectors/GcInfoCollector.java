...
/**
 * Garbage collection information diagnostic collector.
 *
 * @since 5.8
 */
public final class GcInfoCollector implements Collector {
    ...
    public void collect(final Instant timestamp, final DiagnosticInstructions instructions,
        ...
        generator.writeArrayFieldStart("collectors");
        for (GarbageCollectorMXBean gc : gcBeans) {
            generator.writeStartObject();
            generator.writeStringField("name", gc.getName());
            generator.writeNumberField("collectionCount", gc.getCollectionCount());
            generator.writeNumberField("collectionTime", gc.getCollectionTime());
