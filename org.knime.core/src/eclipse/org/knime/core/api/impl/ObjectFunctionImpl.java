...
import org.knime.core.api.workflow.function.ObjectFunction;
 ...
 */
public class ObjectFunctionImpl
    implements ObjectFunction<NodeModel>, ParametrizedFunction<ParametersImpl, ParametersImpl> {

    private final ParametersImpl m_parameters = null;
    ...
    public PortObjectSpec[] specify(final PortObjectSpec[] inSpecs) {
        //        getFunctionObject().loadAndValidate(m_parameters.getSettings());
        //       return getFunctionObject().configure(inSpecs);
        return null;
    }
    ...
    public PortObject[] apply(final PortObject[] inObjs) {
        //        getFunctionObject().execute(inObjs);
        return null;
    }
     ...
     */
    @Override
    public NodeModel getFunctionObject() {
        return null;
    }
