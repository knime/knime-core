...
public final class StateRegistry {
    ...
    void registerState(final Entity e, final State s) {

    }

    <E extends Entity, S extends State> List<S> getStates(final E e, final Class<S> s) {
        return null;
    }

    <E extends Entity, S extends State> S getState(final E e, final Class<S> s) {
        return null;
    }
