...
/**
 * A filter for node identifiers based on regular expressions or plain text patterns.
 * It determines node matches for customization settings.
 *
...
final class PatternFilter implements INodeFilter {
    ...
    @JsonCreator
    PatternFilter(@JsonProperty("patterns") final List<String> patternStrings,
