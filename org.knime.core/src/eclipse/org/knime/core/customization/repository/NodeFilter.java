...
/**
 * Interface defining a filter for node identifiers, used to determine if a node should be visible or usable
 * according to the customization settings.
 *
...
sealed interface NodeFilter permits PatternFilter, ImplementationFilter, TrueFilter {
     ...
     *            filter
     * @return {@code true} if the node identifier matches the filter, otherwise {@code false}.
     */
