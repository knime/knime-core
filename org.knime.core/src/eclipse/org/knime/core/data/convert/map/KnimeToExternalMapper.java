...
public interface KnimeToExternalMapper<D extends Destination<?>, P extends ConsumerParameters<D>> {
     ...
     * @param parameters the consumption parameters for each cell (column) of the row.
     * @throws MappingException if an error occurs during the mapping or consumption operation.
     */
    void map(DataRow row, D destination, @SuppressWarnings("unchecked") P... parameters) throws MappingException;
}
