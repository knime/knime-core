...
/**
 * Interface for {@link CellValueConsumer consumers} of Java primitive {@code boolean} values.
 *
 ...
 */
public interface BooleanCellValueConsumer<D extends Destination<?>, CP extends Destination.ConsumerParameters<D>>
    extends PrimitiveCellValueConsumer<D, Boolean, CP> {

    /**
     * Writes the given {@code boolean} value to the given destination using the given parameters.
     *
     ...
     */
    void consumeBooleanCellValue(D destination, boolean value, CP params) throws MappingException;

    @Override
    default void consumeCellValue(final D destination, final Boolean value, final CP consumerParams)
        throws MappingException {
        if (value != null) {
            consumeBooleanCellValue(destination, value, consumerParams);
        } else {
