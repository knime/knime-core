 ...
 */
public interface TypedDataCellToJavaConverterFactory<S extends DataValue, D, C extends DataCellToJavaConverter<S, D>>
    extends DataCellToJavaConverterFactory<S, D> {
