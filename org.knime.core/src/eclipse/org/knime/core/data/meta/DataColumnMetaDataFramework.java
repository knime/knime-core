 ...
 *
 * History
 *   Oct 30, 2019 (Adrian Nembach, KNIME GmbH, Konstanz, Germany): created
 */
package org.knime.core.data.meta;

/**
 * Common super-interface of interfaces that are used by the MetaData framework.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 * @param <T> the type of {@link DataColumnMetaData} this framework class is concerned with
