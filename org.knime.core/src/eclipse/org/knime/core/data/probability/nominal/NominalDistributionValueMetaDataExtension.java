...
/**
 * {@link DataColumnMetaDataExtension} for {@link NominalDistributionValueMetaDataCreator} objects.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 * @since 4.1
 */
public final class NominalDistributionValueMetaDataExtension
    implements DataColumnMetaDataExtension<NominalDistributionValueMetaData> {

    /**
     * {@inheritDoc}
     */
    @Override
    public DataColumnMetaDataCreator<NominalDistributionValueMetaData> create() {
     ...
     */
    @Override
    public DataColumnMetaDataSerializer<NominalDistributionValueMetaData> createSerializer() {
        return new NominalDistributionValueMetaData.NominalDistributionValueMetaDataSerializer();
    }
