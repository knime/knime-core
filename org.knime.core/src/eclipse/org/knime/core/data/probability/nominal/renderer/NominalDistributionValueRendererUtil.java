...
/**
 * Contains utility functions concerning renderes for {@link NominalDistributionValue} objects.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class NominalDistributionValueRendererUtil {

    private NominalDistributionValueRendererUtil() {
        // static utility class
    }

    static boolean accepts(final DataColumnSpec spec) {
