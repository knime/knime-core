...
final class ColumnRearrangerFunction extends StreamableFunction {
    ...
    private final int m_uniqueFactoryCount;
    private final Vector<SpecAndFactoryObject> m_includes;
    private final Vector<SpecAndFactoryObject> m_reducedIncludes;
    ...
    ColumnRearrangerFunction(final ColumnRearranger rearranger,
        ...
        m_includes = rearranger.getIncludes();
        m_reducedIncludes = RearrangeColumnsTable.createReducedList(m_includes);
        m_uniqueFactoryCount = RearrangeColumnsTable
        .getUniqueProducerFactories(m_reducedIncludes).size();
    ...
    public DataRow compute(final DataRow inputRow) {
        DataRow appendRow = RearrangeColumnsTable.calcNewCellsForRow(
                inputRow, m_reducedIncludes, m_uniqueFactoryCount);
        return JoinTableIterator.createOutputRow(inputRow, appendRow,
                m_includesIndices, m_isFromRefTables);
    }
    ...
    public void finish() {
        super.finish();
        RearrangeColumnsTable.finishProcessing(m_reducedIncludes);
    }
