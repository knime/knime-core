 ...
 *
 * @author Moditha Hewasinghagel, KNIME AG, Berlin, Germany
 * @since 4.5
 */
@SuppressWarnings("serial")
public final class XMLValueRenderer2 extends MultiLineStringValueRenderer {
    /**
    ...
    public static final class Factory extends AbstractDataValueRendererFactory {
        ...
        public DataValueRenderer createRenderer(final DataColumnSpec colSpec) {
            return new XMLValueRenderer2(DESCRIPTION);
        }
    }
     ...
     */
    XMLValueRenderer2(final String description) {
        super(description);
    }

    /**
     * Abbreviate long XML strings for rendering the preview.
     */
    @Override
