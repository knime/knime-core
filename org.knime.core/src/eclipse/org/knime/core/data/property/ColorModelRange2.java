...
public final class ColorModelRange2 implements ColorModel {
    ...
    private static final NodeLogger LOGGER = NodeLogger.getLogger(ColorModelRange2.class);
    ...
    public ColorAttr getColorAttr(final DataCell dc) {
        ...
        return interpolateLab(numValues, value);
    }

    private ColorAttr interpolateLab(final int numValues, final double value) {
        var i = 0;
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == null || !(obj instanceof ColorModelRange2)) {
            return false;
        }
