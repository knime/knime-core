...
public abstract class TableFilterTransformation implements TableTransformation {
    ...
    private FilterInformation m_filter;

    public TableFilterTransformation(final DirectAccessTable table, final FilterInformation filter) {
     ...
     * @return the filter
     */
    public FilterInformation getFilter() {
        return m_filter;
    }
