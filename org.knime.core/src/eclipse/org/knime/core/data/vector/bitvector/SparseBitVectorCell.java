...
public class SparseBitVectorCell extends DataCell implements BitVectorValue {
    ...
    public static final class Factory implements FromSimpleString, FromComplexString {
        ...
        /**
         * Creates a new SparseBitVectorCell from the hex representation in the
         ...
         * @return the {@link SparseBitVectorCell}
         ...
         * @since 4.1
         */
        @DataCellFactoryMethod(name = "String (Hex\u2192Sparse)")
        public static DataCell createCellFromHexString(final String hexString) {
            return new SparseBitVectorCell(new SparseBitVector(hexString));
        }
