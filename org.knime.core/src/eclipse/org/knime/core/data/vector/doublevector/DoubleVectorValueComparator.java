...
public class DoubleVectorValueComparator extends DataValueComparator {
    ...
    /**
     * Compares two {@link DoubleVectorValue}s. Order is defined by index -- first comparing values at position 0;
    ...
    public int compareDataValues(final DataValue v1, final DataValue v2) {
        DoubleVectorValue vector1 = (DoubleVectorValue)v1;
        DoubleVectorValue vector2 = (DoubleVectorValue)v2;
        ...
        for (int i = 0; i < minLength; i++) {
            double d1 = vector1.getValue(i);
            double d2 = vector2.getValue(i);
