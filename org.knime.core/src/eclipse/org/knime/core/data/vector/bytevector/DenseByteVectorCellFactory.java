...
public class DenseByteVectorCellFactory {
    ...
    /**
     * Sets the new byte value at the specified index. The passed int value must be between 0 and 255, otherwise an
     ...
     *             vector
     * @throws IllegalArgumentException if the value is negative or larger than 255
     * @since 2.9
     */
    public void setValue(final int byteIndex, final int byteVal) {
        m_vector.set(byteIndex, byteVal);
    }
