...
public class PNGImageCell extends DataCell implements PNGImageValue {
    /**
     * Serializer for {@link PNGImageCell}.
     *
     * @since 3.0
     * @noreference This class is not intended to be referenced by clients.
     */
    public static final class PNGSerializer implements DataCellSerializer<PNGImageCell> {
        @Override
        public PNGImageCell deserialize(final DataCellDataInput input) throws IOException {
            return new PNGImageCell(PNGImageContent.deserialize(input));
        }

        @Override
        public void serialize(final PNGImageCell cell, final DataCellDataOutput output) throws IOException {
