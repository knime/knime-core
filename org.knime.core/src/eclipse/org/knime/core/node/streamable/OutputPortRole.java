 ...
 */
public final class OutputPortRole extends PortRole {

    /** Distributable output, not merged. */
    public static final OutputPortRole DISTRIBUTED = new OutputPortRole(true);

    /** Non distributable, merged output. */
    public static final OutputPortRole NONDISTRIBUTED = new OutputPortRole(false);

    /**
     * @param isDistributable */
    private OutputPortRole(final boolean isDistributable) {
