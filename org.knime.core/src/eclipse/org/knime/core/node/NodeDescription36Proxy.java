...
/**
 * Implementation of {@link NodeDescription} for node descriptions introduced with 3.6. It uses XMLBeans to extract the
 ...
 * @since 3.6
 */
public final class NodeDescription36Proxy extends NodeDescription {
    private static final XmlOptions OPTIONS = new XmlOptions();

    private static final NodeLogger logger = NodeLogger.getLogger(NodeDescription36Proxy.class);
     ...
     */
    public NodeDescription36Proxy(final Document doc) throws XmlException {
     ...
     */
    public NodeDescription36Proxy(final KnimeNodeDocument doc) {
        m_document = doc;
        setIsDeprecated(m_document.getKnimeNode().getDeprecated());
