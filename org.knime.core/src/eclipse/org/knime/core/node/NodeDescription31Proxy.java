...
public final class NodeDescription31Proxy extends NodeDescription {
    ...
    public List<DialogOptionGroup> getDialogOptionGroups() {
        return NodeDescriptionUtil.extractDialogOptionGroups(
                ...
                Tab::getName, e -> null, Tab::getOptionList, Option::getName, Option::getOptional
        );
    }
