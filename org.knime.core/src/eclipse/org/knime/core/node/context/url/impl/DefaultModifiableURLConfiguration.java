...
/**
 * An modifiable URL configuration instance.
 *
 * @author Mark Ortmann, KNIME GmbH, Berlin, Germany
 */
public final class DefaultModifiableURLConfiguration extends DefaultURLConfiguration
    implements ModifiableURLConfiguration {
     ...
     * @param url the url
     */
    public DefaultModifiableURLConfiguration(final URL url) {
        super(url);
    }
    ...
    @Override
    public DefaultModifiableURLConfiguration copy() {
        // url's are immutable
        return new DefaultModifiableURLConfiguration(getUrl());
    }
