...
public final class FlowTryCatchContext extends FlowScopeContext {
    ...
    public void setErrorToFlowObjectStack(final String node, final String reason, final String stacktrace,
        ...
        fos.push(new FlowVariable(FlowTryCatchContext.ERROR_NODE, node));
        fos.push(new FlowVariable(FlowTryCatchContext.ERROR_REASON, reason));
        if (stacktrace != null) {
            fos.push(new FlowVariable(FlowTryCatchContext.ERROR_STACKTRACE, stacktrace));
        }
    }
