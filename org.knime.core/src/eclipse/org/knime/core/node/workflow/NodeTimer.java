...
public final class NodeTimer {
    ...
    public static final class GlobalNodeStats {
        ...
        private static final long SAVEINTERVAL = 20 * 1000; // save no more than every 15mins
        ...
        private void addExecutionTime(final NodeContainer nc, final boolean success, final long exectime) {
            ...
            synchronized (this) {
                var ns = m_globalNodeStats.get(nodeKey);
                if (ns == null) {
        ...
        public void addConnectionCreation(final NodeContainer source, final NodeContainer dest) {
            ...
            // synchronized to avoid conflicts and parallel file writes
            synchronized (this) {
                var ns = m_globalNodeStats.get(NodeKey.get(source));
                if (ns == null) {
        ...
        private JsonObject constructJSONObject(final boolean properShutdown) {
            ...
            job.add(NodeTimerConstants.NR_WUI_PERSPECTIVE, m_webUIPerspectiveSwitches);
            job.add(NodeTimerConstants.NR_JUI_PERSPECTIVE, m_javaUIPerspectiveSwitches);
                ...
                for (String key : jo.keySet()) {
                    switch (key) {
                        ...
                        case NodeTimerConstants.WFS_EXPORTED:
                            ...
                            break;
                        case NodeTimerConstants.NR_WUI_PERSPECTIVE:
                            m_webUIPerspectiveSwitches = jo.getInt(key);
                            break;
                        case NodeTimerConstants.NR_JUI_PERSPECTIVE:
