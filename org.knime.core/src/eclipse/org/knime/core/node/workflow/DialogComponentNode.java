 ...
 * @since 2.8
 */
public interface DialogComponentNode {

    public void saveDialogComponentSettings(final NodeSettingsWO settings);

    public void loadDialogComponentSettings(final NodeSettingsRO settings);
}
