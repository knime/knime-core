 ...
 * @author wiswedel
 */
public class FileNativeNodeContainerLoader extends FileSingleNodeContainerPersistor
    implements NativeNodeContainerPersistor, NodeContainerLoader {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(FileNativeNodeContainerLoader.class);
     ...
     * @param version
     */
    FileNativeNodeContainerLoader(final ReferencedFile nodeSettingsFile, final WorkflowLoadHelper loadHelper,
