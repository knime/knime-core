...
import org.knime.core.node.workflow.FromFileNodeContainerPersistor;
...
import org.knime.core.node.workflow.SubNodeContainerPersistor;
 ...
 * @since 2.10
 */
public final class FileSubNodeContainerLoader extends FileSingleNodeContainerPersistor implements
    SubNodeContainerPersistor, TemplateNodeContainerPersistor, NodeContainerLoader {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(FileSubNodeContainerLoader.class);
     ...
     * @since 3.7
     */
    public FileSubNodeContainerLoader(final ReferencedFile nodeSettingsFile, final WorkflowLoadHelper loadHelper,
     ...
     */
    @Override
    public NodeDef getLoadResult(final WorkflowPersistor parentPersistor, final NodeSettingsRO parentSettings,
