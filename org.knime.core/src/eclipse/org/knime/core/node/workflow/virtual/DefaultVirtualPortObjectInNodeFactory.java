 ...
 */
public class DefaultVirtualPortObjectInNodeFactory extends DynamicNodeFactory<DefaultVirtualPortObjectInNodeModel> {
     ...
     * @since 2.10
     */
    public DefaultVirtualPortObjectInNodeFactory() {
    }

    /** Client side constructor. */
    public DefaultVirtualPortObjectInNodeFactory(final PortType[] outTypes) {
        CheckUtils.checkArgumentNotNull(outTypes, "Port type array argument must not be null");
        m_outTypes = outTypes;
        init();
    }
    ...
    protected NodeDescription createNodeDescription() {
        return new DelegateNodeDescription(super.parseNodeDescriptionFromFile()) {
            ...
            public String getOutportDescription(final int index) {
                return "The data chunk for the current execution - set by external caller.";
            }
    ...
    @Override
    public DefaultVirtualPortObjectInNodeModel createNodeModel() {
        return createNodeModel(m_outTypes);
    }

    protected DefaultVirtualPortObjectInNodeModel createNodeModel(final PortType[] outTypes) {
        return new DefaultVirtualPortObjectInNodeModel(outTypes);
    }
     ...
     */
    @Override
    public NodeView<DefaultVirtualPortObjectInNodeModel> createNodeView(final int viewIndex,
        final DefaultVirtualPortObjectInNodeModel nodeModel) {
        return null;
    }
