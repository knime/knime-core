...
final class VirtualSubNodeInputNodeDialogPane extends NodeDialogPane {
    ...
    private final JTextArea m_subNodeDescription = new JTextArea();
    ...
    private JPanel initLayout() {
        ...
        gbc.gridwidth = 2;
        gbc.weighty = 0;
        result.add(new JLabel("Choose variables from workflow to be visible inside the Wrapped Node"), gbc);
    ...
    private JPanel createSubNodeDescriptionPanel() {
        ...
        panel.setBorder(new TitledBorder(new EtchedBorder(), "Wrapped Node Description"));
        return panel;
    }
