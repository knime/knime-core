 ...
 */
final class VirtualSubNodeInputNodeDialogPane extends NodeDialogPane {
    ...
    private String[] m_portNames = new String[0];
    private String[] m_portDescriptions = new String[0];

    /** Default const.
     * @param numberOfPorts The number of out ports of this virtual in node */
    VirtualSubNodeInputNodeDialogPane(final int numberOfPorts) {
        ...
        m_portNames = new String[numberOfPorts];
        m_portDescriptions = new String[numberOfPorts];
    }
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        ...
        VirtualSubNodeInputConfiguration configuration = new VirtualSubNodeInputConfiguration(m_portNames.length);
        ...
        configuration.setSubNodeDescription(m_subNodeDescription);
        configuration.setPortNames(m_portNames);
        configuration.setPortDescriptions(m_portDescriptions);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs) {
        ...
        m_subNodeDescription = configuration.getSubNodeDescription();
        ...
        for (int i = 0; i < m_portNames.length; i++) {
            m_portNames[i] = i < portNames.length ? portNames[i] : "";
            m_portDescriptions[i] = i < portDescriptions.length ? portDescriptions[i] : "";
        }
    }
