...
abstract class AbstractStorageNodeContainerMetaPersistor implements NodeContainerMetaPersistor {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(AbstractStorageNodeContainerMetaPersistor.class);
     ...
     */
    AbstractStorageNodeContainerMetaPersistor(final WorkflowLoadHelper loadHelper, final LoadVersion version) {
    ...
    /** {@inheritDoc} */
    @Override
    public abstract ReferencedFile getNodeContainerDirectory();
