 ...
 * @since 2.6
 */
public class DataTypeColumnFilter implements NameFilter<DataColumnSpec> {
     ...
     *        the type allowed in {@link #includeT(DataColumnSpec)}
     */
     ...
     */
    @Override
    public final boolean includeT(final DataColumnSpec cspec) {
