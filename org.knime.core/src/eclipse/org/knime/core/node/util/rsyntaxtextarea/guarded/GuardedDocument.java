...
public class GuardedDocument extends RSyntaxDocument {
     ...
     * @param syntaxStyle
     */
    public GuardedDocument(final TokenMakerFactory tmf, final String syntaxStyle) {
    ...
    private static Class<?> getFoldManagerListenerClass() {
     ...
     */
    public void replaceBetween(final String guard1, final String guard2, final String s) throws BadLocationException {
     ...
     */
    public String getTextBetween(final String guard1, final String guard2) throws BadLocationException {
        int start = getGuardedSection(guard1).getEnd().getOffset();
        int end = getGuardedSection(guard2).getStart().getOffset();
        if (end < start) {
            throw new BadLocationException("The offset of the first guarded"
     ...
     */
    public GuardedSection addGuardedSection(final String name, final int offset) throws BadLocationException {
     ...
     * @throws BadLocationException if offset is in a guarded section
     */
    public GuardedSection addGuardedFooterSection(final String name, final int offset) throws BadLocationException {
        return doAddGuardedSection(name, offset, true);
    }

    /** Add a named guarded section to the document. */
    private GuardedSection doAddGuardedSection(final String name, final int offset, final boolean isFooter) throws BadLocationException {
        for (GuardedSection gs : m_guards.values()) {
