...
/**
 * Constants for the KNIME-specific node logger patterns.
 */
public final class NodeLoggerPatternConstants {
    // extracted for visibility to NodeLogger outside of package and this package, but not exported
    ...
    private NodeLoggerPatternConstants() {
        // utility
    }
