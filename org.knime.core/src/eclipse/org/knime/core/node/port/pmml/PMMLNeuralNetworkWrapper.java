 ...
 * @since 2.8
 */
public class PMMLNeuralNetworkWrapper extends PMMLModelWrapper {

    private NeuralNetwork m_model;

    /**
     * Creates a wrapper for a org.dmg.pmml.TreeModelDocument.TreeModel.
     * @param model The org.dmg.pmml.TreeModelDocument.TreeModel
     */
    public PMMLNeuralNetworkWrapper(final NeuralNetwork model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.NeuralNetwork;
    }
