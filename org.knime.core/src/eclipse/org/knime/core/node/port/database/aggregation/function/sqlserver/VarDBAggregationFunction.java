...
public final class VarDBAggregationFunction extends AbstractDistinctDBAggregationFunction {
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        private static final VarDBAggregationFunction INSTANCE = new VarDBAggregationFunction();
        ...
        public DBAggregationFunction createInstance() {
            return new VarDBAggregationFunction();
        }
    }

    private VarDBAggregationFunction() {
        super(false);
    }

    private VarDBAggregationFunction(final boolean distinct) {
        super(distinct);
    }
    ...
    public String getDescription() {
        return "Returns the statistical variance of all values";
    }
