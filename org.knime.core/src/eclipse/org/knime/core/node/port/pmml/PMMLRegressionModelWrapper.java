 ...
 * @since 2.8
 */
public class PMMLRegressionModelWrapper extends PMMLModelWrapper {

    private RegressionModel m_model;

    /**
     * Creates a wrapper for a org.dmg.pmml.TreeModelDocument.TreeModel.
     * @param model The org.dmg.pmml.TreeModelDocument.TreeModel
     */
    public PMMLRegressionModelWrapper(final RegressionModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.RegressionModel;
    }
