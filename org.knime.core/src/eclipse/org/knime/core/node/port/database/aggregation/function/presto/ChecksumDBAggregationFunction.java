...
/**
 * This class adds support for the <tt>CHECKSUM</tt> aggregation function.
 *
 * @author Ole Ostergaard, KNIME.com
 * @since 3.4
 */
public final class ChecksumDBAggregationFunction extends SimpleDBAggregationFunction {
    ...
    private ChecksumDBAggregationFunction() {
        super(ID, "Returns an order-insensitive checksum of the given values.", StringCell.TYPE, DataValue.class);
    }
}
