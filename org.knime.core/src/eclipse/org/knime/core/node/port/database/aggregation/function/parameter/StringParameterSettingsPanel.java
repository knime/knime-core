 ...
 * @since 3.4
 */
public class StringParameterSettingsPanel extends JPanel {

    private static final long serialVersionUID = 1;
    private final DialogComponentString m_stringComponent;

    /**
     * @param settings The {@link StringParameterSettings}
     * @param label the label for this panel
     */
    public StringParameterSettingsPanel(final StringParameterSettings settings, final String label) {
        ...
        m_stringComponent = new DialogComponentString(parameterModel, label);
        rootPanel.add(m_stringComponent.getComponentPanel(),
            c);
        add(rootPanel);
    }
    ...
    public void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec spec)
        ...
        m_stringComponent.loadSettingsFrom(settings, new DataTableSpec[] {spec});
    }
}
