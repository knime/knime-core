 ...
 * @since 3.4
 */
public final class VarianceDBAggregationFunction extends AbstractDistinctDBAggregationFunction {
    private static final String LABEL = "VARIANCE";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new VarianceDBAggregationFunction();
        }
    }

    private VarianceDBAggregationFunction() {
        super(false);
    }

    private VarianceDBAggregationFunction(final boolean distinct) {
        super(distinct);
    }
