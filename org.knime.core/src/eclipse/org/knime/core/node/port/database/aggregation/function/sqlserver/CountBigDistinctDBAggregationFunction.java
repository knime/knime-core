...
/**
 * This class adds support for the <tt>COUNT_BIG</tt> aggregation function.
 *
 * @author Ole Ostergaard, KNIME.com, Konstanz, Germany
 * @since 3.3
 */
public class CountBigDistinctDBAggregationFunction extends AbstractDistinctDBAggregationFunction {

    private static final String LABEL = "COUNT_BIG";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new CountBigDistinctDBAggregationFunction();
        }
    }
     ...
     * Constructor.
     */
    public CountBigDistinctDBAggregationFunction() {
        this(false);
    }

    private CountBigDistinctDBAggregationFunction(final boolean distinct) {
        super(distinct);
    }
