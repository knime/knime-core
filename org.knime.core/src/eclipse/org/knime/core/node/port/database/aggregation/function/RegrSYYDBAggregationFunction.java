 ...
 * @since 2.11
 */
public class RegrSYYDBAggregationFunction extends AbstractColumnDBAggregationFunction {

    private static final String ID = "REGR_SYY";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new RegrSYYDBAggregationFunction();
        }
    }
     ...
     * Constructor.
     */
    public RegrSYYDBAggregationFunction() {
    ...
    public String getDescription() {
        return "The function regr_syy(Y, X) returns the 'sum of squares' of the dependent variable "
                + "(sum(Y^2) - sum(Y)^2/N).";
    }
}
