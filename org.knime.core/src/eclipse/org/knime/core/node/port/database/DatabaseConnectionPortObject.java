...
public class DatabaseConnectionPortObject implements PortObject {
     ...
     * Database port type.
     */
    public static final PortType TYPE = PortTypeRegistry.getInstance().getPortType(DatabaseConnectionPortObject.class);

    /**
     * Database type for optional ports.
     */
    public static final PortType TYPE_OPTIONAL =
        PortTypeRegistry.getInstance().getPortType(DatabaseConnectionPortObject.class, true);
