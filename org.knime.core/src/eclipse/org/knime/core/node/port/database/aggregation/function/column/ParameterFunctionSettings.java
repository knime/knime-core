...
/**
 * Class that saves the settings of the {@link ParameterFunctionSettingsPanel}.
 *
 * @author Ole Ostergaard
 * @since 3.3
 */
public class ParameterFunctionSettings {
     ...
     */
    public ParameterFunctionSettings(final String selected) {
     ...
     */
    public ParameterFunctionSettings createClone() {
        return new ParameterFunctionSettings(getParameter());
    }
    ...
    public boolean equals(final Object obj) {
        ...
        ParameterFunctionSettings other = (ParameterFunctionSettings)obj;
        if (m_parameter == null) {
