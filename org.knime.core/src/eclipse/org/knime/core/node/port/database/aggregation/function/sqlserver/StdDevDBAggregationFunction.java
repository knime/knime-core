...
/**
 * This class adds support for the <tt>STDEV</tt> aggregation function.
 *
...
public final class StdDevDBAggregationFunction extends AbstractDistinctDBAggregationFunction {
    private static final String LABEL = "STDEV";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new StdDevDBAggregationFunction();
        }
    }

    private StdDevDBAggregationFunction() {
        super(false);
    }

    private StdDevDBAggregationFunction(final boolean distinct) {
        super(distinct);
    }
    ...
    public String getDescription() {
        return "Returns the statistical standard deviation of all values";
    }
