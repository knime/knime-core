 ...
 * @since 3.3
 */
public abstract class AbstractColumnParameterDBAggregationFunction extends AbstractColumnDBAggregationFunction {

    private ParameterFunctionSettingsPanel m_parameterSettingsPanel;
    private final ParameterFunctionSettings m_parameterSettings;
     ...
     * @param parameters
     * @param defaultColName
     * @param classFilter
     */
    @SafeVarargs
    protected AbstractColumnParameterDBAggregationFunction(final String parameterLabel, final String defaultParameter,
        final List<String> parameters, final String colLabel,final String defaultColName, final Class<? extends DataValue>... classFilter) {
        super(colLabel, defaultColName, classFilter);
        m_parameterLabel = parameterLabel;
        m_parameters = parameters;
        m_parameterSettings = new ParameterFunctionSettings(defaultParameter);
    }
    ...
    private void checkParameterPanel() {
        if (m_parameterSettingsPanel == null) {
            m_parameterSettingsPanel = new ParameterFunctionSettingsPanel(m_parameterSettings, m_parameterLabel, m_parameters);
        }
    }
