 ...
 * @since 2.11
 */
public final class VarPopDBAggregationFunction extends SimpleDBAggregationFunction {
    private static final String ID = "VAR_POP";

    /**Factory for the parent class.*/
    public static final class Factory implements DBAggregationFunctionFactory {
        private static final VarPopDBAggregationFunction INSTANCE = new VarPopDBAggregationFunction();
