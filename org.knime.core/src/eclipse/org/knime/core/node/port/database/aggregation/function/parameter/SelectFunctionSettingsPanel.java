...
public class SelectFunctionSettingsPanel extends JPanel {
    ...
    private final DialogComponentStringSelection m_parameterComponent;

    /**
     * @param settings The {@link SelectFunctionSettings}
     * @param label The label for ths panel
     * @param parameters the parameters available
     */
    public SelectFunctionSettingsPanel(final SelectFunctionSettings settings, final String label,
        ...
        c.gridx = 0;
        c.gridy = 0;
        final SettingsModelString parameterModel = settings.getModel();
        m_parameterComponent = new DialogComponentStringSelection(parameterModel, label, parameters);
        rootPanel.add(m_parameterComponent.getComponentPanel(),
            c);
        add(rootPanel);
    }
    ...
    public void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec spec)
        ...
        m_parameterComponent.loadSettingsFrom(settings, new DataTableSpec[] {spec});
    }
}
