...
public class StatsModeDBAggregationFunction extends SimpleDBAggregationFunction {
    ...
    private static final String ID = "STATS_MODE";

    /**Factory for the parent class.*/
    public static final class Factory implements DBAggregationFunctionFactory {
        private static final StatsModeDBAggregationFunction INSTANCE = new StatsModeDBAggregationFunction();
    ...
    private StatsModeDBAggregationFunction() {
        super(ID, "Computes the mode (most frequent value).", null, DataValue.class);
    }
}
