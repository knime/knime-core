 ...
 * @since 3.4
 */
public final class StatsTTestPairedDBAggregationFunction extends AbstractColumnFunctionSelectDBAggregationFunction {

    private static final String ID = "STATS_T_TEST_PAIRED";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new StatsTTestPairedDBAggregationFunction();
        }
     ...
     * Constructor.
     */
    private StatsTTestPairedDBAggregationFunction() {
    ...
    public String getColumnName() {
        ...
        if (selectedParam.length() >= 5) {
            selectedParam = selectedParam.substring(0, 5);
        }
        return "TPaired" + "_" + selectedParam + "_" + getSelectedColumnName() ;
    }
    ...
    public String getDescription() {
        return "Measures the significance of the difference between two means. "
