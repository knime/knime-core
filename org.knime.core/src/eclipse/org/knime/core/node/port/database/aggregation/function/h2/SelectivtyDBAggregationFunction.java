...
public class SelectivtyDBAggregationFunction extends SimpleDBAggregationFunction {
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        private static final SelectivtyDBAggregationFunction INSTANCE = new SelectivtyDBAggregationFunction();
    ...
    private SelectivtyDBAggregationFunction() {
        super(ID, "The selectivity of the column (100 * distinctCount / rowCount).", null, DataValue.class);
    }
}
