 ...
 * @since 2.8
 */
public class PMMLNaiveBayesModelWrapper extends PMMLModelWrapper {
     ...
     */
    public PMMLNaiveBayesModelWrapper(final NaiveBayesModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.NaiveBayesModel;
    }
