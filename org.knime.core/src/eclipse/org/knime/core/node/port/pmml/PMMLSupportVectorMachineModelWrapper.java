 ...
 * @since 2.8
 */
public class PMMLSupportVectorMachineModelWrapper extends PMMLModelWrapper {

    private SupportVectorMachineModel m_model;

    /**
     * Creates a wrapper for a org.dmg.pmml.TreeModelDocument.TreeModel.
     * @param model The org.dmg.pmml.TreeModelDocument.TreeModel
     */
    public PMMLSupportVectorMachineModelWrapper(final SupportVectorMachineModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.SupportVectorMachineModel;
    }
    ...
    public void addToSegment(final Segment s) {
        s.setSupportVectorMachineModel(m_model);
    }
