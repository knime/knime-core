 ...
 * @since 2.11
 */
public class CovarSampDBAggregationFunction extends AbstractColumnDBAggregationFunction {

    private static final String ID = "COVAR_SAMP";
    ...
    public static final class Factory implements DBAggregationFunctionFactory {
        ...
        public DBAggregationFunction createInstance() {
            return new CovarSampDBAggregationFunction();
        }
    }
     ...
     * Constructor.
     */
    public CovarSampDBAggregationFunction() {
    ...
    public String getDescription() {
        return "Returns the sample covariance of a pair of numeric columns in the group";
    }
}
