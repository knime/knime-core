...
public class PMMLElements {
    ...
    public static final String NORM_CONT = "NormContinuous";
    public static final String LINEAR_NORM = "LinearNorm";
    ...
    public static final String OP_TYPE_CONTINOUS = "continuous";
}
