 ...
 * @since 2.12
 */
public class PMMLMiningModelWrapper extends PMMLModelWrapper {

    private MiningModel m_model;

    /**
     * Creates a wrapper for a org.dmg.pmml.TreeModelDocument.TreeModel.
     * @param model The org.dmg.pmml.TreeModelDocument.TreeModel
     */
    public PMMLMiningModelWrapper(final MiningModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.MiningModel;
    }
