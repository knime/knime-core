 ...
 * @since 2.8
 */
public class PMMLClusteringModelWrapper extends PMMLModelWrapper {
     ...
     */
    public PMMLClusteringModelWrapper(final ClusteringModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.ClusteringModel;
    }
