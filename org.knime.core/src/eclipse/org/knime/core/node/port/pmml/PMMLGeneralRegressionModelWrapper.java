 ...
 * @since 2.8
 */
public class PMMLGeneralRegressionModelWrapper extends PMMLModelWrapper {

    private GeneralRegressionModel m_model;

    /**
     * Creates a wrapper for a org.dmg.pmml.TreeModelDocument.TreeModel.
     * @param model The org.dmg.pmml.TreeModelDocument.TreeModel
     */
    public PMMLGeneralRegressionModelWrapper(final GeneralRegressionModel model) {
        m_model = model;
    }
    ...
    public PMMLModelType getModelType() {
        return PMMLModelType.GeneralRegressionModel;
    }
    ...
    public void addToSegment(final Segment s) {
        s.setGeneralRegressionModel(m_model);
    }
