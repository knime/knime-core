 ...
 * @since 3.3
 */
public class ParameterFunctionSettingsPanel extends JPanel {
     ...
     * @param parameters
     */
    public ParameterFunctionSettingsPanel(final ParameterFunctionSettings settings, final String label,
