...
import org.knime.node.v28.AbstractView;
import org.knime.node.v28.InPortDocument.InPort;
import org.knime.node.v28.IntroDocument;
...
import org.knime.node.v28.TabDocument;
...
/**
 * Implementation of {@link NodeDescription} for node descriptions introduced with 2.8. It uses XMLBeans to extract the
...
public final class NodeDescription28Proxy extends NodeDescription {
     ...
     */
    public NodeDescription28Proxy(final Document doc) throws XmlException {
     ...
     */
    public NodeDescription28Proxy(final KnimeNodeDocument doc) {
        m_document = doc;
        setIsDeprecated(m_document.getKnimeNode().getDeprecated());
    ...
    public List<DialogOptionGroup> getDialogOptionGroups() {
        return NodeDescriptionUtil.extractDialogOptionGroups(
                ...
                TabDocument.Tab::getName, e -> null, TabDocument.Tab::getOptionList,
