 ...
 * ---------------------------------------------------------------------
 *
 * Created on 29.04.2013 by Christian Albrecht, KNIME.com AG, Zurich, Switzerland
 */
...
import org.knime.core.node.NodeViewExport.ViewContainerProvider;
 ...
 * @since 2.8
 */
public abstract class InteractiveClientSwingView<T extends NodeModel & InteractiveNode> extends InteractiveClientView<T>
    ...
    private final WindowListener m_windowListener = new WindowAdapter() {
        ...
        public void windowClosing(final WindowEvent e) {
            ...
            InteractiveClientSwingView.super.closeView();
        }
    };
     ...
     * @param nodeModel
     */
    protected InteractiveClientSwingView(final T nodeModel) {
        super(nodeModel);
        ...
        final WeakReference<InteractiveClientSwingView<?>> viewRef = new WeakReference<InteractiveClientSwingView<?>>(this);
        final JMenuItem exportMenu = NodeViewExport.createNewMenu(new ViewContainerProvider() {
            @Override
            public Container getContainer() {
                InteractiveClientSwingView<?> referent = viewRef.get();
    ...
    /** {@inheritDoc} */
    @Override
    protected final void callModelChanged() {
