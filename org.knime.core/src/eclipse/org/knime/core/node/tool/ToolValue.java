...
public interface ToolValue extends DataValue {
    ...
    /**
     * @return Description of the tool used by an AI Agent to pick a tool.
     */
    String getDescription();
    /**
     * @return the JSON schema of the parameters used by the tool.
     */
     ...
     * as well as output data that the agent can use to execute subsequent tools with.
     *
     * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
    ...
    /**
     * TODO does this live here or e.g. in a static utility method?
     *
