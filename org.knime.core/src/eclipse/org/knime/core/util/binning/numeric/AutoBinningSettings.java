...
public record AutoBinningSettings( //
     ...
     */
    public sealed interface ColumnOutputNamingSettings permits AppendSuffix, ReplaceColumn {
    ...
    public static final class NumberFormatSettingsGroup /*implements DefaultNodeSettings*/ {
        ...
        //                in the bins.
        //                """)
        public RoundingDirection m_roundingMode = RoundingDirection.HALF_UP;
