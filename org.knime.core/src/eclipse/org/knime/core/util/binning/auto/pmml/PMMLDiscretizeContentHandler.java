...
final class PMMLDiscretizeContentHandler extends PMMLContentHandler {
    private static final NodeLogger LOGGER = NodeLogger.getLogger(PMMLDiscretizeContentHandler.class);
     ...
     */
    PMMLDiscretizeContentHandler(final Stack<PMMLContentHandler> contentHandlerStack, final Attributes atts,
    ...
    public void endElement(final String uri, final String localName, final String name) throws SAXException {
        if ("Extension".equals(name)) {
            ...
            m_list.add(new PMMLDiscretize(m_field, m_mapMissingTo, m_defaultValue, m_dataType, m_bins));
        } else {
    ...
    public void startElement(final String uri, final String localName, final String name, final Attributes atts)
        throws SAXException {
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in Discretize: " + name);
        } else if ("DiscretizeBin".equals(name)) {
            m_contentHandlerStack.push(new PMMLDiscretizeBinContentHandler(m_contentHandlerStack, atts, m_bins));
        } else {
            throw new SAXException("Unknown xml element in Discretize: " + name);
        }
    }
