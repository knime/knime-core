...
public class PMMLPreprocDiscretizeTranslatorConfiguration {
    ...
    public PMMLBinningTranslator2 toTranslator() {
        ...
        var convertedBinsByColumnName = m_binsByColumnName.entrySet().stream() //
            // we have to cast our NumericBins to Bins, but the Translator will convert
            // them back to NumericBins. Don't ask me why it's written that way.
    ...
    public static record Interval(double leftMargin, double rightMargin, ClosureStyle closure) {
        ...
        /**
         * Creates a new Interval with the specified left and right margins and closure style, and checks the validity
         * of the margins.
         *
         * @param leftMargin the left margin of the interval
         * @param rightMargin the right margin of the interval
    ...
    /**
     * Builder for creating a binning configuration.
     *
    ...
    /**
     * Builder class for constructing a binning configuration.
     */
    public static final class Builder {
        ...
        private Builder() {
            ...
            m_orderedInputColumnNames = new ArrayList<>();
            m_orderedOutputColumnNames = new ArrayList<>();
        }

        /**
         * Adds a column with its associated bins to the configuration.
         *
         * @param inputColumnName the name of the column
         * @param outputColumnName the name of the output column
         * @param bins the list of bins for the column
         * @return this builder instance for method chaining
         */
        public Builder addColumn(final String inputColumnName, final String outputColumnName,
            final List<NumericBin2> bins) {
            m_binsByColumnName.put(inputColumnName, bins);
            m_orderedInputColumnNames.add(inputColumnName);
            m_orderedOutputColumnNames.add(outputColumnName);
            return this;
        }

        /**
         * Builds the {@link PMMLPreprocDiscretizeTranslatorConfiguration} instance with the accumulated bins.
         *
         * @return a new binning configuration instance
         */
        public PMMLPreprocDiscretizeTranslatorConfiguration build() {
            return new PMMLPreprocDiscretizeTranslatorConfiguration( //
                m_orderedInputColumnNames, //
                m_orderedOutputColumnNames, //
                m_binsByColumnName //
            );
        }
    }
