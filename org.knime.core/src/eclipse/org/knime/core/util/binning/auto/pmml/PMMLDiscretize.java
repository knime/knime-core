...
public final class PMMLDiscretize {
     ...
     * @param bins the bins
     */
    public PMMLDiscretize(final String field, final List<PMMLDiscretizeBin> bins) {
     ...
     * @param bins the bins
     */
    public PMMLDiscretize(final String field, final String mapMissingTo, final String defaultValue,
