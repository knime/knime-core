...
public final class PMMLPreprocDiscretize extends PMMLPreprocOperation {
    ...
    public void save(final TransformerHandler handler, final ExecutionMonitor executionMonitor) throws SAXException {
        final List<String> names = m_configuration.getNames();
        for (String name : names) {
            ...
            final PMMLDiscretize discretize = m_configuration.getDiscretize(name);
     ...
     * @author Heiko Hofer
     */
    static final class PMMLPreprocDiscretizeContentHandler extends PMMLContentHandler {
        private final DisretizeConfiguration m_configuration;
         ...
         */
        PMMLPreprocDiscretizeContentHandler(final DisretizeConfiguration configuration) {
