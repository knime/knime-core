 ...
 */
package org.knime.core.util.binning.auto.pmml;
...
final class PMMLIntervalContentHandler extends PMMLContentHandler {
    private static final NodeLogger LOGGER = NodeLogger.getLogger(PMMLIntervalContentHandler.class);
     ...
     */
    PMMLIntervalContentHandler(final Stack<PMMLContentHandler> contentHandlerStack, final Attributes atts,
        final List<PMMLInterval> list) {
        m_contentHandlerStack = contentHandlerStack;
        m_list = list;

        final Closure closure = Closure.valueOf(atts.getValue("closure"));

        final double leftMargin = null != atts.getValue("leftMargin") ? Double.valueOf(atts.getValue("leftMargin"))
            : Double.NEGATIVE_INFINITY;
        final double rightMargin = null != atts.getValue("rightMargin") ? Double.valueOf(atts.getValue("rightMargin"))
    ...
    public void endElement(final String uri, final String localName, final String name) throws SAXException {
        if ("Extension".equals(name)) {
            ...
            final PMMLContentHandler me = m_contentHandlerStack.pop();
    ...
    public void startElement(final String uri, final String localName, final String name, final Attributes atts)
        ...
        if ("Extension".equals(name)) {
            ...
            throw new SAXException("Unknown xml element in Interval: " + name);
        }
    }
