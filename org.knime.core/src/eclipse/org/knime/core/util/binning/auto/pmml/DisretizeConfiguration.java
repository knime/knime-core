...
public class DisretizeConfiguration {
    ...
    /**
     * @return the names of the columns holding the discretized values
     */
    ...
    /**
     * @param name
     * @return the discretization for the given column name
     */
    public PMMLDiscretize getDiscretize(final String name) {
        return m_discretize.get(name);
    }
     ...
     * @param value
     */
    void addName(final String value) {
        m_names.add(value);
    }
