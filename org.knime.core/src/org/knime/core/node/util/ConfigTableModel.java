...
/**
 * Extends the {@link TableModel} by convenient methods for the
 * {@link ConfigTableModel}.
 *
 * @author Heiko Hofer
 */
public interface ConfigTableModel extends TableModel {
     ...
     * model.
     * @param model values are initialized with values of this model
     */
    public void setTableData(ConfigTableModel model);

    /**
     * Clear all values, \i.e. remove all rows.
     */
    public void clear();
