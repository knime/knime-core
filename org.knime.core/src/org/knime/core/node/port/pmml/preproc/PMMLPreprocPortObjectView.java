 ...
 */
public class PMMLPreprocPortObjectView extends JComponent {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(
            PMMLPreprocPortObjectView.class);

    private final PMMLPreprocPortObject m_portObject;
     ...
     */
    public PMMLPreprocPortObjectView(final PMMLPreprocPortObject portObject) {
        setLayout(new BorderLayout());
        setBackground(NodeView.COLOR_BACKGROUND);
        m_portObject = portObject;
        setName("PMML Preproc ("
                + m_portObject.getOperations().size() + " operations)");
        m_tree = new JTree();
        create();
    }
    ...
    private void create() {
        ...
        synchronized (m_lock) {
            try {
                ...
                PMMLPreprocPortObjectView.this.add(
                        new JLabel("PMML Preproc contains errors: "
                                + e.getMessage()));
            }
        }
    }
