...
public class XFilter extends XMLFilterImpl {
    ...
    static {
        ...
        XMLNS_MAP.put("4.0", "http://www.dmg.org/PMML-4_0");
    }

    private final String m_xmlns;

    /**
     * @param version the PMML version
     */
