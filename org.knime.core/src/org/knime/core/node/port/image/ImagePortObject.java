...
public class ImagePortObject extends AbstractPortObject {
    ...
    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(ImagePortObject.class);
    ...
    /** Create new port object based on the given arguments. The cell class
     * that is generated by the {@link ImageContent#toImageCell()} method must
     * be compatible to all DataValue of the spec's
     ...
     * verifies the requirements stated in the {@link ImagePortObject#
     * ImagePortObject(ImageContent, ImagePortObjectSpec) constructor}.
        ...
        try {
            ...
            if (!ImageContent.class.isAssignableFrom(contentCl)) {
                throw new IOException(
                        "Unrecognized image content class: " + contentClName);
            }
            cnt = (ImageContent)contentCl.newInstance();
        } catch (Exception e) {
