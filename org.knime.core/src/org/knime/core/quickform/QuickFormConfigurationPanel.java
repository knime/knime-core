...
public abstract class QuickFormConfigurationPanel
        <CFG extends AbstractQuickFormConfiguration> {

    /** Default constructor. */
    protected QuickFormConfigurationPanel() {
        // empty
    }

    /**
     * An array of components shown in the derived dialog. Each component needs
     * to provide a name, {@link JComponent#getName()} that is used as label
     * within the dialog.
