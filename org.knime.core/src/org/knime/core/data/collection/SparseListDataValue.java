...
/**
 * Sparse implementation of the {@link ListDataValue} interface that stores
 * only the value and the index of elements that are unequal to
 * the default element.
 *
 * @author Tobias Koetter, University of Konstanz
 */
public interface SparseListDataValue extends ListDataValue {
    ...
    /**
     * @return the default element that is returned for all indices within the
