...
/**
 * Factory class to create cell objects representing SDF structures from a
 * string. Depending on the size of the underlying string, an ordinary
 * {@link DataCell} or a {@link BlobDataCell} is created. The default threshold
 * in bytes is {@value #DEF_MIN_BLOB_SIZE_IN_BYTES}, though it can be changed
 * by providing the system property <i>org.knime.sdfminblobsize</i> at VM
 * startup, for instance by providing the vm argument
 * <i>-Dorg.knime.sdfminblobsize=32k</i>.
 *
 * @author Bernd Wiswedel, University of Konstanz
 */
public final class PNGImageCellFactory {

    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(PNGImageCellFactory.class);
