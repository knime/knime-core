...
public class BitVectorUtilTest {
	...
	@Test
	public void testCardinalityOfIntersection() {
		...
		for (int i = 1; i < 1000; i++) {
			...
			String second = new BigInteger(RANDOM.nextInt(i % 5 == 0 ? i * 100
					: 50), RANDOM).toString(16);

			DenseBitVectorCell a = new DenseBitVectorCellFactory(first)
					.createDataCell();

			DenseBitVectorCell b = new DenseBitVectorCellFactory(second)
					.createDataCell();

			Assert.assertEquals(
					"Broken add: " + a.toHexString() + "|" + b.toHexString(),
					DenseBitVectorCellFactory.and(a, b).cardinality(),
					BitVectorUtil.cardinalityOfIntersection(a, b));

			Assert.assertEquals(
					"Broken add: " + a.toHexString() + "|" + b.toHexString(),
					DenseBitVectorCellFactory.and(b, a).cardinality(),
	...
	@Test
	public void testCardinalityOfRelativeComplement() {
