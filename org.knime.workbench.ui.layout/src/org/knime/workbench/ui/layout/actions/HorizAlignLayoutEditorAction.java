...
/**
 * Editor action to start horizontal alignment.
 *
 * @author Peter Ohl, KNIME.com, Zurich, Switzerland
 */
public class HorizAlignLayoutEditorAction extends AbstractEditorAction {

    /** {@inheritDoc} */
    @Override
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new HorizAlignLayoutAction(editor);
    }
