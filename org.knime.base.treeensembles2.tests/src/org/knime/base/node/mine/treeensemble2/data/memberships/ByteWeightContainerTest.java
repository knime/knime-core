 ...
 *
 * History
 *   04.02.2016 (Adrian Nembach): created
 */
...
public class ByteWeightContainerTest {
    private static ByteWeightContainer initializeContainer() {
        ...
        rowCounts.add(3);
        rowCounts.add(2);
        return new ByteWeightContainer(rowCounts);
    }

    @Test
    public void testGetWeight() {
        ByteWeightContainer bwc = initializeContainer();
        assertEquals(1.0, bwc.getWeight(0), 1e-8);
        assertEquals(3.0, bwc.getWeight(1), 1e-8);
        assertEquals(2.0, bwc.getWeight(2), 1e-8);
    }
