 ...
 */
public final class DefaultModel implements FluentNodeAPI {
    ...
    BiConsumer<ExecuteInput, ExecuteOutput> m_execute;
    ...
    public static final class RequirePortsAndConfigure {

        private final DefaultModel m_model;

        private RequirePortsAndConfigure(final DefaultModel model) {
            m_model = model;
        }
        ...
        public RequirePortsAndConfigure addInputPort(final String name, final PortType type, final String description,
            final boolean configurable) {
            m_model.m_inputPortDescriptions.add(new PortDescription(name, type, description, configurable));
            return this;
        }
        ...
        public RequirePortsAndConfigure addOutputPort(final String name, final PortType type, final String description,
            final boolean configurable) {
            m_model.m_outputPortDescriptions.add(new PortDescription(name, type, description, configurable));
            return this;
        }
        ...
        public RequireExecute configure(final BiConsumer<ConfigureInput, ConfigureOutput> configure) {
            m_model.m_configure = configure;
            return execute -> {
                m_model.m_execute = execute;
                return m_model;
            };
        }
    }
    ...
    public interface RequireExecute {
        DefaultModel execute(BiConsumer<ExecuteInput, ExecuteOutput> execute);
