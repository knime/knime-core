...
/**
 * Factory for job managers. Just does nothing on job execution (inactive outputs).
 * @author wiswedel
 */
public final class NoopExecutionJobManagerFactory implements NodeExecutionJobManagerFactory {
    ...
    public String getLabel() {
        return "Noop Execution";
    }

    @Override
    public NodeExecutionJobManager getInstance() {
        return NoopExecutionJobManager.INSTANCE;
    }
