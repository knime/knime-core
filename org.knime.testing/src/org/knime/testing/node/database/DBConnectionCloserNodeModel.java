 ...
 */
public class DBConnectionCloserNodeModel extends NodeModel {


    /**
     *
     */
    public DBConnectionCloserNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        connSettings.execute(cp, conn -> {conn.close(); return null;});
        return inObjects;
    }
    /**
     * {@inheritDoc}
