 ...
 */
public class TestDataNodeDialog extends DefaultNodeSettingsPane {

    /**Constructor for class TestDataNodeDialog.
     *
     */
    public TestDataNodeDialog() {
        ...
        addDialogComponent(new DialogComponentNumber(
                ...
                "No of list items: ", Integer.valueOf(1)));
        addDialogComponent(new DialogComponentNumber(
                TestDataNodeModel.createNoOfSetItemsModel(),
                "Maximum no of set items: ", Integer.valueOf(1)));
        addDialogComponent(new DialogComponentNumber(
