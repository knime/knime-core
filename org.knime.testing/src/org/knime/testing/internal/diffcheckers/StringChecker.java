...
/**
 * Checker for strings which optionally ignores different line feeds (Windows vs. Unix).
 *
...
public class StringChecker implements DifferenceChecker<StringValue> {
     ...
     */
    public static class Factory implements DifferenceCheckerFactory<StringValue> {
        /**
         * {@inheritDoc}
         */
        @Override
        public Class<StringValue> getType() {
         ...
         */
        @Override
        public DifferenceChecker<StringValue> newChecker() {
            return new StringChecker();
        }
    }

    static final String DESCRIPTION = "Strings";
