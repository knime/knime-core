 ...
 * @author KNIME GmbH
 */
public class DummyNodeNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "org.knime.timeseries";

    // The shared instance.
    private static DummyNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public DummyNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DummyNodeNodePlugin getDefault() {
        return plugin;
    }
