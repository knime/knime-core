...
/**
 * Handler uses the last known value for the missing.
 *
...
public class TSLastHandler extends TSMissVHandler {
    ...
    /**
     * The last known value of the time series.
     */
    ...
    public void incomingValue(final RowKey key, final DataCell newCell) {
        if (newCell.isMissing()) {
            // the DC is missing, use the last known value.
            addToDetected(key, m_previous);
        } else {
            m_previous = newCell;
        }
    }
