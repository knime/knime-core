 ...
 */
public class BarChartNodeDialog extends DefaultNodeSettingsPane {
    ...
    public BarChartNodeDialog(final int defaultNrOfRows) {
        super();
        addDialogComponent(new DialogComponentNumber(
                new SettingsModelIntegerBounded(
                BarChartNodeModel.CFG_END, defaultNrOfRows, 
                1, Integer.MAX_VALUE), "No. of rows to display:", 10));
        addDialogComponent(new DialogComponentBoolean(
                new SettingsModelBoolean(
                        BarChartNodeModel.CFG_ANTIALIAS,false), 
                        "Enable Antialiasing"));  
        
        SettingsModelString columnName =
            new SettingsModelString(BarChartNodeModel.CFG_COLUMN_NAME,
                    null);
