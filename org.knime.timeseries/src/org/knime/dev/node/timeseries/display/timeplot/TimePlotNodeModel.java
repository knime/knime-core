 ...
 */
package org.knime.dev.node.timeseries.display.timeplot;
...
import org.knime.dev.types.TimestampValue;
import org.knime.base.node.viz.plotter.node.DefaultVisualizationNodeModel;;


/**
 * Implementation of a 
 * {@link org.knime.base.node.viz.plotter.node.DefaultVisualizationNodeModel} 
 * which sets, stores, and retrieves 
 * 1. the column to be used to label the x-axis
 * 2. the incoming data of inport 0 into a 
 * {@link org.knime.base.node.util.DataArray} with the maximum number of rows 
 * specified in the {@link TimePlotNodeDialog}, loading and saving 
 ...
 */
public class TimePlotNodeModel extends DefaultVisualizationNodeModel implements 
    DataProvider {
     ...
     */
    public TimePlotNodeModel(final int nrInports, 
...
//    }
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs)
      ...
      try {
        ...
        // look for timestamp values to put on x-axis
        int colIndex = -1;
     ...
     * defined in the {@link TimePlotNodeDialog}. Thereby nominal 
