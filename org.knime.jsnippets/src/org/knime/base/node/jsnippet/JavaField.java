...
public class JavaField {
     ...
     * @author Heiko Hofer
     */
    public static class JavaColumnField extends JavaField {
     ...
     * @author Heiko Hofer
     */
    public static class JavaFlowVarField extends JavaField {
        private static final String KNIME_TYPE = "Type";
     ...
     * @author Heiko Hofer
     */
    public static class InCol extends JavaColumnField {
     ...
     * @author Heiko Hofer
     */
    public static class InVar extends JavaFlowVarField {
        // just a marker, nothing to add.
    }
     ...
     * @author Heiko Hofer
     */
    public static class OutCol extends JavaColumnField {
     ...
     * @author Heiko Hofer
     */
    public static class OutVar extends JavaFlowVarField {
        private static final String REPLACE_EXISTING = "replaceExisting";
