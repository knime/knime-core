...
import org.knime.base.node.jsnippet.JavaSnippetNodeDialog;
...
public class DefaultTemplateController implements TemplateController {
    private JavaSnippetNodeDialog m_model;
    private JavaSnippetNodeDialog m_preview;
     ...
     */
    public DefaultTemplateController(final JavaSnippetNodeDialog model,
            final JavaSnippetNodeDialog preview) {
        super();
        m_model = model;
        m_preview = preview;
    }
     ...
     */
    @Override
    public void setSettings(final JSnippetTemplate template) {
