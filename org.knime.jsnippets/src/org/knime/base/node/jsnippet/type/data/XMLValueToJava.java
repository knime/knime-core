...
/**
 * Provides the value of a XMLValue object for the java snippet node.
 *
 * @author Heiko Hofer
 */
public class XMLValueToJava extends DataValueToJava {

    /**
     * Create a new instance.
     */
    public XMLValueToJava() {
    ...
    public boolean isCompatibleTo(final DataCell cell, final Class c)
        ...
        return c.equals(Document.class)
            && cell.getType().isCompatible(XMLValue.class);
    }
