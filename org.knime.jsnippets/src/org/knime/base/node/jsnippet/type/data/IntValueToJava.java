...
/**
 * Provides the value of an IntValue object for the java snippet node.
 *
 * @author Heiko Hofer
 */
public class IntValueToJava extends DataValueToJava {

    /**
     * Create a new instance.
     */
    public IntValueToJava() {
        super(Integer.class);
    }
    ...
    public boolean isCompatibleTo(final DataCell cell, final Class c)
        ...
        return canProvideJavaType(c)
            && cell.getType().isCompatible(IntValue.class);
    }
