 ...
 * @author Heiko Hofer
 */
public class AbstractTypeConversion implements TypeConverter {
         ...
         * @param canJavaTypes
         */
        public AbstractTypeConversion(final Class... canJavaTypes) {
            super();
        ...
        public boolean canProvideJavaType(final Class javaType) {
            return Arrays.binarySearch(m_canJavaTypes, javaType, new Comparator<Class>() {
