...
/**
 * A type conversion for collection data types.
 *
 * @author Heiko Hofer
 */
public class ListCellTypeConversion extends DataValueToJava {
     ...
     */
    public ListCellTypeConversion(final DataValueToJava typeConverter) {
