 ...
 */
public class NewNaiveBayesPredictorNodeDialog extends DefaultNodeSettingsPane {
     ...
     */
    public NewNaiveBayesPredictorNodeDialog() {
        super();
        final SettingsModelBoolean inclProbValsModel = new SettingsModelBoolean(
                NewNaiveBayesPredictorNodeModel.CFG_INCL_PROBABILITYVALS_KEY,
                false);
        final DialogComponentBoolean inclprobValsComponent =
         ...
         final SettingsModelDouble laplaceCorrectorModel =
             new SettingsModelDoubleBounded(
                     NewNaiveBayesPredictorNodeModel.CFG_LAPLACE_CORRECTOR_KEY,
         ...
         addDialogComponent(new DialogComponentBoolean(new SettingsModelBoolean(
                     NewNaiveBayesPredictorNodeModel.CFG_USE_LOG, true),
                     "Use log summation"));
         addDialogComponent(new DialogComponentBoolean(new SettingsModelBoolean(
                 NewNaiveBayesPredictorNodeModel.CFG_NORMALIZE, true),
