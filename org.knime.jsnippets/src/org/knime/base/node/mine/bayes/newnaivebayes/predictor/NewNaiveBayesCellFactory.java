 ...
 */
public class NewNaiveBayesCellFactory implements AppendedCellFactory,
CellFactory {
    ...
    private final boolean m_useLog;
     ...
     */
    public NewNaiveBayesCellFactory(final NaiveBayesModel model,
            final DataTableSpec tableSpec, final boolean inclClassProbVals) {
        this(model, tableSpec, inclClassProbVals, 0.0, false, true);
    }
    /**Constructor for class NaiveBayesAlgorithm.
     * @param model the <code>NaiveBayesModel</code> which holds all necessary
     * information to calculate the probability for new records.
     ...
     * by adding the log
     * @param normalize <code>true</code> if probabilities should be normalized
     */
    public NewNaiveBayesCellFactory(final NaiveBayesModel model,
            final DataTableSpec tableSpec, final boolean inclClassProbVals,
    ...
    public DataCell[] getCells(final DataRow row) {
        ...
        final double[] classProbs = m_model.getClassProbabilities(
                m_attributeNames, row, m_sortedClassVals, m_normalize,
                m_laplaceCorrector, m_useLog);
