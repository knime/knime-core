 ...
 */
public class NewNaiveBayesLearnerNodeModel extends NodeModel {

    // our logger instance
    private static final NodeLogger LOGGER = NodeLogger
            .getLogger(NewNaiveBayesLearnerNodeModel.class);
     ...
     *
     */
    protected NewNaiveBayesLearnerNodeModel() {
//      we have one data in port for the training data and one model out port
    ...
    protected PortObject[] execute(final PortObject[] inData,
        ...
        LOGGER.debug("Entering execute of "
                + NewNaiveBayesLearnerNodeModel.class.getName());
//      check input data
