 ...
 */
public class NewNaiveBayesLearnerNodeView
extends NodeView<NewNaiveBayesLearnerNodeModel> {
     ...
     */
    protected NewNaiveBayesLearnerNodeView(
...
/*
    ...
    protected void modelChanged() {
        final NewNaiveBayesLearnerNodeModel nodeModel = getNodeModel();
        m_model = nodeModel.getNaiveBayesModel();
        if (m_model != null) {
