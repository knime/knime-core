...
public class IndexOfOffsetManipulator implements StringManipulator {
    ...
    public String getDescription() {
        return "Gives the first index of toSearch in the string. The search is "
                + "performed from the starting point to the right."
                + "The given index is an integer between start and "
                + "length(str) - 1 (the last character). A negative value of "
                + "start is treated as zero. The function returns -1 if "
                + "toSearch is not found."
                + ""
                + "<br/><br/>"
