...
public class PadRightManipulator implements Manipulator {
    ...
    public String getDescription() {
        return "Right pads string with spaces (' ') such that the length of the string equals the provided size. "
                + "<br/><br/>"
                ...
                + "<tr><td>padRight(\"KNIME\", 8)</td>"
                + "<td>=&nbsp;\"KNIME&nbsp;&nbsp;&nbsp;\"</td></tr>"

                + "<tr><td>padRight(\"\", 1)</td>"
                + "<td>=&nbsp;\"&nbsp;\"</td></tr>"

                + "<tr><td>padRight(\"KNIME\", 6)</td><td>=&nbsp;\"KNIME&nbsp;\"</td></tr>"
