...
/**
 * The node dialog of the string manipulation node for flow variables.
 *
 * @author Heiko Hofery
 * @author Thorsten Meinl, University of Konstanz
 */
public class StringManipulationVariableNodeDialog2 extends NodeDialogPane {
     ...
     * Create new instance.
     */
    public StringManipulationVariableNodeDialog2() {
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final PortObjectSpec[] specs)
        ...
        String defaultNewName = "new variable";
