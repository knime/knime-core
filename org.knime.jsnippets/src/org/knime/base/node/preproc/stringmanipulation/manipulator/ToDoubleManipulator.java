...
public class ToDoubleManipulator implements Manipulator {
     ...
     * @return the double value
     */
    public static Double toDouble(final Integer x) {
        if (null == x) {
            return null;
        }
     ...
     * @return the double value
     */
    public static Double toDouble(final Double x) {
        return x;
    }
    ...
    public String getDescription() {
        return "Converts input to a double value."
            + ""
            + ""
            + "<br/>"
            + "<br/>"
