...
/**
 * Abstract base class for {@link RulesToTableNodeDialog} and org.knime.base.node.rules.engine.decisiontree.FromDecisionTreeNodeDialog.
 *
 * @author Gabor Bakos
 ...
 */
public abstract class AbstractRulesToTableNodeDialog<T extends RulesToTableSettings> extends DefaultNodeSettingsPane {

    /**
     * Constructs the base settings.
     */
    protected AbstractRulesToTableNodeDialog() {
        super();
        T settings = createSettings();
        ...
        createScoreDistribution(settings);
    }

    /**
     * @return The settings with the proper type for the dialog.
     */
    protected abstract T createSettings();

    /**
     * Adds the controls for the Score distribution.
     *
     * @param settings The settings for the node.
     * @since 3.2
     */
    protected abstract void createScoreDistribution(final T settings);
