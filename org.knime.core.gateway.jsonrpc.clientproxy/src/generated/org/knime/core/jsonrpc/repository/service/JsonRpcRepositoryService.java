 ...
 *
 */
package org.knime.core.jsonrpc.repository.service;
...
public interface JsonRpcRepositoryService extends RepositoryService {
     ...
     */
    @Override
    @JsonRpcMethod(value = "RepositoryService.getNodeRepository")
     ...
     */
    @Override
    @JsonRpcMethod(value = "RepositoryService.getNodeDescription")
