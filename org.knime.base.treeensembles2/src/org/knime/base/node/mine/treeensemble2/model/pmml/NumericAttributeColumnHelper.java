...
final class NumericAttributeColumnHelper extends AbstractAttributeColumnHelper<TreeNumericColumnMetaData> {
    ...
    NumericAttributeColumnHelper(final DataColumnSpec colSpec, final int colIdx) {
        super(colSpec, colIdx);
    }
     ...
     */
    @Override
    protected TreeNumericColumnMetaData createMetaData(final DataColumnSpec colSpec) {
        return new TreeNumericColumnMetaData(colSpec.getName());
    }
