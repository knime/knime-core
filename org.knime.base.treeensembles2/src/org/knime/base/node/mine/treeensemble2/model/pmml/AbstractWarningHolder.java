    ...
    public final String getWarning() {
        if (m_warning == null) {
            throw new IllegalStateException(
                "No warning present. Please call hasWarning to ensure that a warning is present.");
        }
        return m_warning;
    }

    protected void addWarning(final String warningMsg) {
        StringBuilder sb;
        if (m_warning == null) {
            sb = new StringBuilder();
        } else {
            sb = new StringBuilder(m_warning);
            sb.append("\n");
        }
