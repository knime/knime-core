...
public final class RegressionGBTModelPMMLTranslator extends AbstractGBTModelPMMLTranslator<GradientBoostedTreesModel> {
     ...
     */
    @Override
    protected AbstractGBTModelImporter<GradientBoostedTreesModel>
        createImporter(final MetaDataMapper<TreeTargetNumericColumnMetaData> metaDataMapper) {
        return new RegressionGBTModelImporter(new LiteralConditionParser(metaDataMapper),
     ...
     */
    @Override
    protected AbstractGBTModelExporter<GradientBoostedTreesModel> createExporter(
        final DerivedFieldMapper derivedFieldMapper) {
        return new RegressionGBTModelExporter(getGBTModel(), derivedFieldMapper);
    }
