...
public class RegressionTreeModelPortObjectSpec extends AbstractSimplePortObjectSpec {
    ...
    /*
     * Framework Constructor needed for serialization
     */
    public RegressionTreeModelPortObjectSpec() {
        // do not use in node
    }

    public RegressionTreeModelPortObjectSpec(final DataTableSpec learnSpec) {
        if (learnSpec == null) {
            throw new NullPointerException("learnSpec must not be null.");
        }
