...
/**
 * View for simple regression tree learner nodes.
 *
 * @author Bernd Wiswedel, KNIME AG, Zurich, Switzerland
 * @param <MODEL>
 */
public final class RegressionTreeLearnerNodeView
    extends NodeView<RegressionTreeLearnerNodeModel> implements HiLiteListener {

    /** The node logger for this class. */
    private static final NodeLogger LOGGER = NodeLogger.getLogger(RegressionTreeLearnerNodeView.class);
     ...
     */
    public RegressionTreeLearnerNodeView(final RegressionTreeLearnerNodeModel model) {
        super(model);
    ...
    private final class UpdateTreeWorker extends SwingWorkerWithContext<DecisionTreeNode, Void> {
         ...
         * @param model
         *  */
        public UpdateTreeWorker(final DataTable hiliteRowSample, final RegressionTreeModel model) {
        ...
        protected DecisionTreeNode doInBackgroundWithContext() throws Exception {
            ...
            final DecisionTree tree = m_model.createDecisionTree(m_hiliteRowSample);
