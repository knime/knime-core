...
public class TreeModelClassification extends AbstractTreeModel<TreeNodeClassification> {
     ...
     * @param in
     * @param metaData
     * @param treeBuildingInterner used to intern node signatures and BigIntegers
    ...
    public static TreeModelClassification load(final TreeModelDataInputStream in, final TreeMetaData metaData,
        ...
        return new TreeModelClassification(TreeNodeClassification.load(in, metaData, treeBuildingInterner));
    }
