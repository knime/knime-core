...
public final class TreeData {
     ...
     * @param targetColumn
     */
    public TreeData(final TreeAttributeColumnData[] columns, final TreeTargetColumnData targetColumn, final TreeType treeType) {
        m_columns = columns;
        ...
        TreeTargetColumnMetaData targetMetaData = targetColumn.getMetaData();
    ...
    /** @return the columns */
    public TreeAttributeColumnData[] getColumns() {
        return m_columns;
    }
    ...
    public TreeTargetColumnData getTargetColumn() {
