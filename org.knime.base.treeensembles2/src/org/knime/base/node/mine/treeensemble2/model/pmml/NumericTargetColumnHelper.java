...
final class NumericTargetColumnHelper extends TargetColumnHelper<TreeTargetNumericColumnMetaData> {
    ...
    NumericTargetColumnHelper(final DataColumnSpec colSpec) {
        super(colSpec);
    }
     ...
     */
    @Override
    protected TreeTargetNumericColumnMetaData createMetaData(final DataColumnSpec colSpec) {
        return new TreeTargetNumericColumnMetaData(colSpec.getName());
    }
