...
public final class TreeNodeBitCondition extends TreeNodeColumnCondition {
    ...
    /** {@inheritDoc} */
    @Override
    public TreeBitColumnMetaData getColumnMetaData() {
        return (TreeBitColumnMetaData)super.getColumnMetaData();
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected void saveContent(final DataOutputStream out) throws IOException {
    ...
    public String toString() {
        return getColumnMetaData() + " = \"" + Boolean.toString(m_value) + "\"";
    }
