 ...
 */
public class GradientBoostingClassificationPMMLPredictorNodeFactory extends
NodeFactory<GradientBoostingPMMLPredictorNodeModel<MultiClassGradientBoostedTreesModel>> {
    ...
    public NodeView<GradientBoostingPMMLPredictorNodeModel<MultiClassGradientBoostedTreesModel>> createNodeView(
        final int viewIndex, final GradientBoostingPMMLPredictorNodeModel<MultiClassGradientBoostedTreesModel> nodeModel) {
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new GradientBoostingPMMLPredictorNodeDialogPane(false);
    }
