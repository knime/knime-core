...
public class SurrogateSplit {
    ...
    /**
     * Constructor for SurrogateSplit objects
     *
     * @param conditions
     * @param childMarkers
     */
    public SurrogateSplit(final AbstractTreeNodeSurrogateCondition[] conditions, final BitSet[] childMarkers) {
        m_conditions = conditions;
        m_childMarkers = childMarkers;
    }

    /**
     * @return BitSet child markers
     */
    public BitSet[] getChildMarkers() {
        return m_childMarkers;
    }

    /**
     * @return child conditions
     */
    public AbstractTreeNodeSurrogateCondition[] getChildConditions() {
        return m_conditions;
    }
