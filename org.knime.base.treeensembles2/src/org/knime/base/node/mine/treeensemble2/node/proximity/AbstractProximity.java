 ...
 *
 * History
 *   11.01.2016 (Adrian Nembach): created
 */
...
public class AbstractProximity {
    ...
    protected static void finishedTree(final int treeIndex, final ExecutionMonitor progMon, final int nrModels) {
        if (treeIndex > 0) {
            progMon.setProgress(treeIndex / (double)nrModels, "Tree " + treeIndex + "/" + nrModels);
        }
    }

    protected static void checkThrowable(final AtomicReference<Throwable> learnThrowableRef)
