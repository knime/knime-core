...
public class ColMem implements ColumnMemberships {
    ...
    ColMem(final BitSet sorted, final DataIndexManager indexManager, final RootDataMem root, final int colIdx) {
        m_sorted = sorted;
    ...
    public double getRowWeight() {
        return m_root.getRowWeight(m_indexManager.getOriginalIndex(m_colIdx, m_iterator));
    }
    ...
    public int getOriginalIndex() {
        return m_indexManager.getOriginalIndex(m_colIdx, m_iterator);
    }
