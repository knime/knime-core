 ...
 */
public final class TreeEnsembleClassificationPredictorCellFactory2 extends AbstractCellFactory {
    ...
    private TreeEnsembleClassificationPredictorCellFactory2(final TreeEnsemblePredictor predictor,
     ...
     *  */
    public static TreeEnsembleClassificationPredictorCellFactory2 createFactory(final TreeEnsemblePredictor predictor)
        throws InvalidSettingsException {
        ...
        return new TreeEnsembleClassificationPredictorCellFactory2(predictor, targetValueMap, newCols,
...
//                result[index++] = new DoubleCell(freqValue / (double)nrValidModels);
    ...
    private static final class ProbabilityCounter<T> extends HashMap<T, MutableDouble> {
        public double add(final T object, final double probValue) {
            MutableDouble prob = get(object);
            if (prob == null) {
                prob = new MutableDouble(probValue);
                put(object, prob);
            } else {
                prob.add(probValue);
            }
