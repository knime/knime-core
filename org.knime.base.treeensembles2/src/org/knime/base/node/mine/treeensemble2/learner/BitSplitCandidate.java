...
import org.knime.base.node.mine.treeensemble2.data.TreeBitVectorColumnData;
...
public final class BitSplitCandidate extends SplitCandidate {
    ...
    public BitSplitCandidate(final TreeBitVectorColumnData bitColumnData, final double gainValue) {
        // missing values in a bit vector are currently not possible
        super(bitColumnData, gainValue, new BitSet());
    }
    ...
    /** {@inheritDoc} */
    @Override
    public TreeBitVectorColumnData getColumnData() {
        return (TreeBitVectorColumnData)super.getColumnData();
    }
