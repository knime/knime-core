...
public abstract class SplitCandidate {
    ...
    private final BitSet m_missedRows;

    /**
     *  */
    protected SplitCandidate(final TreeAttributeColumnData columnData, final double gainValue, final BitSet missedRows) {
        m_columnData = columnData;
        m_gainValue = gainValue;
        m_missedRows = missedRows;
    }

    /** @return the column */
    public TreeAttributeColumnData getColumnData() {
        return m_columnData;
    }

    public BitSet getMissedRows() {
        return m_missedRows;
    }

    public abstract TreeNodeCondition[] getChildConditions();
