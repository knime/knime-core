 ...
 */
final class NominalTargetColumnHelper extends TargetColumnHelper<TreeTargetNominalColumnMetaData>
implements NomValMapper {

    private Map<String, NominalValueRepresentation> m_val2Rep;

    /**
     * @param nominalColSpec the spec of a nominal column
     *
     */
    public NominalTargetColumnHelper(final DataColumnSpec nominalColSpec) {
        super(nominalColSpec);
    ...
    protected TreeTargetNominalColumnMetaData createMetaData(final DataColumnSpec nominalColSpec) {
        ...
        CheckUtils.checkArgument(domain.hasValues(),
            "The target field \"%s\" in the data dictionary has no possible values assigned.", nominalColSpec);
