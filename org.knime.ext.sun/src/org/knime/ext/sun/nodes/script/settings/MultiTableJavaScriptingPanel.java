...
/**
 * Panel of the Java Joiner node.
 * @author Bernd Wiswedel, University of Konstanz
 * @author Stefano Woerner, University of Konstanz
 * @since 3.5
 */
@SuppressWarnings("serial")
public class MultiTableJavaScriptingPanel extends JPanel {
    ...
    public MultiTableJavaScriptingPanel(final MultiTableJavaScriptingCustomizer customizer,
     ...
     */
    public void loadSettingsFrom(final MultiTableJavaScriptingSettings s,
     ...
     */
    public void saveSettingsTo(final MultiTableJavaScriptingSettings s)
        ...
        if (isTestCompilation && m_currentSpec != null) {
            try {
                MultiTableExpression.compile(s, m_currentSpec);
