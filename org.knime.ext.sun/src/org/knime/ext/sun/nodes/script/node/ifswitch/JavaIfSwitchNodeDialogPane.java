 ...
 */
final class JavaIfSwitchNodeDialogPane extends NodeDialogPane {
     ...
     *
     */
    JavaIfSwitchNodeDialogPane(final JavaScriptingCustomizer customizer) {
        ...
        m_panel = new JavaScriptingPanel(customizer,
            ...
            public Map<String, FlowVariable> getAvailableFlowVariables() {
                JavaIfSwitchNodeDialogPane p = JavaIfSwitchNodeDialogPane.this;
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        jsSettings.loadSettingsInDialog(
                settings, JavaIfSwitchNodeModel.EMPTY_SPEC);
        m_panel.loadSettingsFrom(
                jsSettings, JavaIfSwitchNodeModel.EMPTY_SPEC);
    }
