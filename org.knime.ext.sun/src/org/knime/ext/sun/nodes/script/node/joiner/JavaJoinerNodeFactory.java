 ...
 */
public class JavaJoinerNodeFactory extends
        NodeFactory<JavaJoinerNodeModel> {
     ...
     *
     */
    public JavaJoinerNodeFactory() {
        m_customizer = new MultiTableJavaScriptingCustomizer();
    ...
    /** {@inheritDoc} */
    @Override
    public JavaJoinerNodeModel createNodeModel() {
        return new JavaJoinerNodeModel(m_customizer);
    }
    ...
    /** {@inheritDoc} */
    @Override
    public NodeView<JavaJoinerNodeModel> createNodeView(
            final int viewIndex, final JavaJoinerNodeModel nodeModel) {
        return null;
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new JavaJoinerNodeDialog(m_customizer);
    }
