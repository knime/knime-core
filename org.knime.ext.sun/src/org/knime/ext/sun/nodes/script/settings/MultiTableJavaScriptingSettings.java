 ...
 * @since 3.5
 */
public final class MultiTableJavaScriptingSettings {
    ...
    private int m_expressionVersion = MultiTableExpression.VERSION_2X;
    ...
    private MultiTableExpression m_compiledExpression = null;
    ...
    public MultiTableJavaScriptingSettings(final MultiTableJavaScriptingCustomizer customizer) {
    ...
    public void loadSettingsInModel(final NodeSettingsRO settings)
        ...
        m_expressionVersion = settings.getInt(
                CFG_EXPRESSION_VERSION, MultiTableExpression.VERSION_1X);
        // added in v2.5
    ...
    public void setInputAndCompile(final DataTableSpec spec)
        ...
        if ((m_compiledExpression == null)
            ...
            m_compiledExpression = MultiTableExpression.compile(this, spec);
            m_inputSpec = spec;
        }
    }
     ...
     */
    public MultiTableExpression getCompiledExpression() {
