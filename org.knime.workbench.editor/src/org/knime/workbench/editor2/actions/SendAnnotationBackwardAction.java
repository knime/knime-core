...
/**
 * An action to send the selected annotation backward by one relative-to-other-annotations position.
 *
 * @author loki der quaeler
 */
public class SendAnnotationBackwardAction extends AbstractAnnotationReorderingAction {
    /** unique ID for this action. **/
    public static final String ID = "knime.action.annotationBackward";
     ...
     */
    public SendAnnotationBackwardAction(final WorkflowEditor editor) {
        super(editor, ID);
    }
    ...
    public String getToolTipText() {
        return "Send the selected annotation behind the next most rearward annotation.";
    }
}
