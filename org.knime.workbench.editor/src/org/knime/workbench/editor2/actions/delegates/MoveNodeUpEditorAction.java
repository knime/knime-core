...
import org.knime.workbench.editor2.actions.MoveNodeUpAction;

/**
 * Editor action for moving the selected node(s) up a bit.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class MoveNodeUpEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new MoveNodeUpAction(editor);
    }
}
