...
import org.knime.workbench.editor2.actions.MoveNodeDownAction;

/**
 * Editor action for moving the selected node(s) down a bit.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class MoveNodeDownEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new MoveNodeDownAction(editor);
    }
}
