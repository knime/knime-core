...
/**
 * Editor action for reconfiguring a subnode.
 *
 * @author Ferry Abt, KNIME AG, Zurich, Switzerland
 */
public class SubnodeSetupEditorAction extends AbstractEditorAction {
    /**
     * {@inheritDoc}
     */
    @Override
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new SubNodeReconfigureAction(editor);
    }
}
