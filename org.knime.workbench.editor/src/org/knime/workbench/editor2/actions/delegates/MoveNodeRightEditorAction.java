...
import org.knime.workbench.editor2.actions.MoveNodeRightAction;

/**
 * Editor action for moving the selected node(s) to the right a bit.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class MoveNodeRightEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new MoveNodeRightAction(editor);
    }
}
