...
import org.knime.workbench.editor2.actions.MoveNodeLeftAction;

/**
 * Editor action for moving the selected node(s) to the left a bit.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class MoveNodeLeftEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new MoveNodeLeftAction(editor);
    }
}
