 ...
 * @author tibuch
 */
public class CreateSpaceEditorAction extends AbstractEditorAction {
     ...
     *
     */
    public CreateSpaceEditorAction(final CreateSpaceDirection direction, final int distance) {
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new CreateSpaceAction(editor, m_direction, m_distance);
    }
