...
import org.knime.workbench.editor2.actions.ToggleGridAction;

/**
 * Editor action for toggling the snap to grid property in the current editor.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class ToggleGridEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new ToggleGridAction(editor);
    }
}
