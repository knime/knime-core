...
/**
 * Editor action for sending the selected workflow annotation to the back.
 *
 * @author Peter Ohl, KNIME.com AG, Zurich, Switzerland.
 */
public class SendAnnotationToBackEditorAction extends AbstractEditorAction {
    /**
     * @see
    ...
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new SendAnnotationToBackAction(editor);
    }
}
