...
/**
 * Action to get update meta node templates.
 * @author Bernd Wiswedel, KNIME.com, Zurich, Switzerland
 */
public class UpdateMetaNodeLinkAction extends AbstractNodeAction {

    /** Action ID. */
    public static final String ID = "knime.action.meta_node_update_link";

    /** Create new action based on given editor.
     * @param editor The associated editor. */
    public UpdateMetaNodeLinkAction(final WorkflowEditor editor) {
        super(editor);
    }
    ...
    public String getToolTipText() {
        return "Fetches a new copy of the underlying meta node template";
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        return ImageRepository.getImageDescriptor(
                "icons/meta/metanode_template_refresh.png");
    }
    ...
    public ImageDescriptor getDisabledImageDescriptor() {
        return ImageRepository.getImageDescriptor(
                "icons/meta/metanode_template_refresh_disabled.png");
    }
    ...
    protected boolean calculateEnabled() {
        ...
        for (NodeContainerEditPart p : nodes) {
            ...
            if (model instanceof WorkflowManager) {
                ...
                if (UpdateStatus.HasUpdate.equals(i.getUpdateStatus())) {
                    return true;
                }
            }
        }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        ...
        UpdateMetaNodeLinkCommand updateCmd =
            new UpdateMetaNodeLinkCommand(getManager(), ids);
        execute(updateCmd);
    }
