...
public class MoveNodeRightAction extends MoveNodeAbstractAction {
    ...
    public static final String ID = "knime.action.node.moveright";

    /**
     *
     * @param editor The workflow editor
     */
    public MoveNodeRightAction(final WorkflowEditor editor) {
        super(editor);
    }
    ...
    public String getText() {
        return "Move node right\t" + getHotkey("knime.commands.editor.moveNodesRight");
    }
