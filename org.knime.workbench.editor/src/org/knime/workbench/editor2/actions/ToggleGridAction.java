...
public class ToggleGridAction extends AbstractNodeAction {
    ...
    public static final String ID = "knime.action.editor.toggleGrid";

    /**
     *
     * @param editor The workflow editor
     */
    public ToggleGridAction(final WorkflowEditor editor) {
        super(editor);
    }
    ...
    public void runOnNodes(final NodeContainerEditPart[] nodeParts) {
        EditorUIInformation settings = getEditor().getCurrentEditorSettings();
        settings.setSnapToGrid(!settings.getSnapToGrid());
        getEditor().applyEditorSettings(settings);
        getEditor().markDirty();
    }
}
