...
/**
 * Runnable that saves a workflow in its default location.
 *
 * @author Thorsten Meinl, KNIME.com, Zurich, Switzerland
 */
class InplaceSaveRunnable extends AbstractSaveRunnable {
    private final File m_workflowDir;

    private final WorkflowSaveHelper m_saveHelper;

    InplaceSaveRunnable(final WorkflowEditor editor, final StringBuilder exceptionMessage,
        final WorkflowSaveHelper saveHelper, final IProgressMonitor monitor, final File workflowDir) {
    ...
    protected void save(final WorkflowManager wfm, final ExecutionMonitor exec)
        ...
        wfm.save(m_workflowDir, m_saveHelper, exec);
    }
}
