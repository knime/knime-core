...
/**
 * General tests of the {@link DefaultNode} API that are not covered by one of the more specific test classes.
 */
class DefaultNodeTest extends TestWithWorkflowManager {
    ...
    void testNodeType() {
        ...
        assertThat(nc.getType()).isEqualTo(NodeType.Manipulator);
