...
public class ARFFWriterNodeModel extends NodeModel {
    ...
    protected DataTable[] execute(final DataTable[] inData,
        ...
        writer.write("generated by Hades data analysis workbench\n");
        writer.write("% Hades (c) 2003-2006 Uni Konstanz, Prof. Berthold\n");
        writer.write("%\n");
    ...
    /*
     * translates the Hades type into a string suitable for the <datatype>
