...
public class NodeInPortEntTest {
    ...
    static NodeInPortEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final NodeInPortEnt ent, final List<Object> valueList) {
