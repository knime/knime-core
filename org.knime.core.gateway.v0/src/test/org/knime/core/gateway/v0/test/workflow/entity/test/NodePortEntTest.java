...
public class NodePortEntTest {
    ...
    public void test() {
        ...
        NodePortEnt ent = createEnt(valueList);
        testEnt(ent, valueList);
    }

    public static NodePortEnt createEnt(final List<Object> valueList) {
        NodePortEntBuilder builder = EntityBuilderManager.builder(NodePortEntBuilder.class);
    ...
    public static void testEnt(final NodePortEnt ent, final List<Object> valueList) {
