...
public class WorkflowAnnotationEntTest {
    ...
    static WorkflowAnnotationEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final WorkflowAnnotationEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add("nBtgo");	
 	  	 		...
 	  	 		valueList.add(-329071227);	
 	  	 		valueList.add(-884856179);	
 	  	 		valueList.add(1829900603);	
 	  	 		valueList.add(-1654015793);	
 	  	 		valueList.add("tTSCm");	
 	         return valueList;
    }
