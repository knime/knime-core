...
public class XYEntTest {
    ...
    static XYEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final XYEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add(662938508);	
 	  	 		valueList.add(1808686651);	
 	         return valueList;
    }
