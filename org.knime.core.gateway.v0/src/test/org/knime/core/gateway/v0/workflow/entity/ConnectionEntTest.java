...
public class ConnectionEntTest {
    ...
    static ConnectionEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final ConnectionEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add("5bldb");	
 	  	 		valueList.add(1317105713);	
 	  	 		valueList.add("RsaF1");	
 	  	 		valueList.add(1982371995);	
 	  	 		valueList.add(false);	
