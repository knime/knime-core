...
public class NodeOutPortEntTest {
    ...
    static NodeOutPortEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final NodeOutPortEnt ent, final List<Object> valueList) {
