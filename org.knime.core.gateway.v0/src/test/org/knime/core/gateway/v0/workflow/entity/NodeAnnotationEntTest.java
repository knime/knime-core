...
public class NodeAnnotationEntTest {
    ...
    static NodeAnnotationEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final NodeAnnotationEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add("sgETh");	
 	  	 		valueList.add("oSejK");	
 	  	 		valueList.add(-19668126);	
 	  	 		valueList.add(1139106059);	
 	  	 		valueList.add(1989995016);	
 	  	 		valueList.add(1609747418);	
 	  	 		valueList.add(1113469272);	
 	  	 		valueList.add("vKGyw");	
 	  	 		valueList.add(1409975875);	
 	  	 		valueList.add(-1185138197);	
 	  	 		valueList.add(-1991698183);	
 	  	 		valueList.add(-1906531269);	
 	         return valueList;
    }
