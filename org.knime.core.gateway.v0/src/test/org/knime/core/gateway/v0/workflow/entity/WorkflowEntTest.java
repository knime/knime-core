...
public class WorkflowEntTest {
    ...
    static WorkflowEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final WorkflowEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		//TODO map of primitives?
 		Map<String, List<Object>> subMap1 = new HashMap<>();
 		for(int i = 0; i < 5; i++) {
 			subMap1.put("OH5KI", NodeEntTest.createValueList());
 		}
