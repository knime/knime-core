...
public class AnnotationEntTest {
    ...
    public static AnnotationEnt createEnt(final List<Object> valueList) {
    ...
    public static void testEnt(final AnnotationEnt ent, final List<Object> valueList) {
    ...
    public static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
 		valueList.add("HxLJ7");	
 		valueList.add(718818434);	
 		valueList.add(1965677808);	
 		valueList.add(-672842814);	
 		valueList.add(-556928746);	
 		valueList.add(1784936283);	
 		valueList.add("Yv06p");	
 		valueList.add(-1933052616);	
 		valueList.add(-945306617);	
 		valueList.add(-1962372920);	
 		valueList.add(-1848270027);	
        return valueList;
    }
