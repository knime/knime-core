...
public class XYEntTest {
    ...
    public void test() {
        ...
        XYEnt ent = createEnt(valueList);
        testEnt(ent, valueList);
    }

    public static XYEnt createEnt(final List<Object> valueList) {
        XYEntBuilder builder = EntityBuilderManager.builder(XYEntBuilder.class);
		builder.setX((int) valueList.get(0));
		builder.setY((int) valueList.get(1));
        return builder.build();
    }

    public static void testEnt(final XYEnt ent, final List<Object> valueList) {
    ...
    public static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
 		valueList.add(1369255007);	

 		valueList.add(570403194);	
