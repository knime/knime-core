...
public class NodeInPortEntTest {
    ...
    public void test() {
        ...
        NodeInPortEnt ent = createEnt(valueList);
        testEnt(ent, valueList);
    }

    public static NodeInPortEnt createEnt(final List<Object> valueList) {
        NodeInPortEntBuilder builder = EntityBuilderManager.builder(NodeInPortEntBuilder.class);
    ...
    public static void testEnt(final NodeInPortEnt ent, final List<Object> valueList) {
