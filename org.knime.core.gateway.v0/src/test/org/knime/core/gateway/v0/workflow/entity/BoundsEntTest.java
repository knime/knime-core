...
public class BoundsEntTest {
    ...
    static BoundsEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final BoundsEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add(-1817513955);	
 	  	 		valueList.add(-994544166);	
 	  	 		valueList.add(-278285881);	
 	  	 		valueList.add(-1756723575);	
 	         return valueList;
    }
