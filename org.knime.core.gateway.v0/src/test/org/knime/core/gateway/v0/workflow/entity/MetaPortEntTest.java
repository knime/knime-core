...
public class MetaPortEntTest {
    ...
    static MetaPortEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final MetaPortEnt ent, final List<Object> valueList) {
    ...
    static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
  	 		valueList.add(PortTypeEntTest.createValueList());
 	  	 		valueList.add(true);	
 	  	 		valueList.add("EmhAX");	
 	  	 		valueList.add(-739566311);	
 	  	 		valueList.add(9782582);	
 	         return valueList;
    }
