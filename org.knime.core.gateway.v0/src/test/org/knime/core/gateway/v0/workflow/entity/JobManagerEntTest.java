...
public class JobManagerEntTest {
    ...
    public void test() {
        ...
        JobManagerEnt ent = createEnt(valueList);
        testEnt(ent, valueList);
    }

    static JobManagerEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final JobManagerEnt ent, final List<Object> valueList) {
