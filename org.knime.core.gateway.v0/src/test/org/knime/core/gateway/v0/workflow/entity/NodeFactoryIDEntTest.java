...
public class NodeFactoryIDEntTest {
    ...
    public void test() {
        ...
        NodeFactoryIDEnt ent = createEnt(valueList);
        testEnt(ent, valueList);
    }

    static NodeFactoryIDEnt createEnt(final List<Object> valueList) {
    ...
    static void testEnt(final NodeFactoryIDEnt ent, final List<Object> valueList) {
