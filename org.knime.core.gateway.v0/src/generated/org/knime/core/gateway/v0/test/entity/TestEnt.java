 ...
 *
 */
package org.knime.core.gateway.v0.test.entity;
...
public interface TestEnt extends GatewayEntity {
    ...
    /**
     * @return The xy property.
     */
 	XYEnt getXY();
 	
    /**
     * @return The xy list property.
     */
 	List<XYEnt> getXYList();
 	
    /**
     * @return The other property, no not this one. The other.
     */
 	String getOther();
 	
    /**
     * @return Some simple list of strings.
     */
 	List<String> getPrimitiveList();
 	
    /**
     * @return Some map of properties.
     */
 	Map<String, XYEnt> getXYMap();
 	
    /**
     * @return Some simple list.
     */
