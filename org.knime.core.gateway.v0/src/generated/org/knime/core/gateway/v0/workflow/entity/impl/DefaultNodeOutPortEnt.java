...
/**
 * Default implementation of the NodeOutPortEnt-interface. E.g. used if no other {@link EntityBuilderFactory}
 * implementation (provided via the respective extension point, see {@link EntityBuilderManager}) is available.
 *
 * @author Martin Horn, University of Konstanz
 */
public class DefaultNodeOutPortEnt implements NodeOutPortEnt {
     ...
     * @param builder
     */
    private DefaultNodeOutPortEnt(final DefaultNodeOutPortEntBuilder builder) {
	...
	public static DefaultNodeOutPortEntBuilder builder() {
		return new DefaultNodeOutPortEntBuilder();
	}
	
	/**
	* Default implementation of the NodeOutPortEntBuilder-interface.
	*/
