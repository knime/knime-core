...
/**
 * Default implementation of the EntityID-interface. E.g. used if no other {@link EntityBuilderFactory}
...
public class DefaultEntityID implements EntityID {
     ...
     * @param builder
     */
    private DefaultEntityID(final DefaultEntityIDBuilder builder) {
		m_ID = builder.m_ID;
	...
	public static DefaultEntityIDBuilder builder() {
		return new DefaultEntityIDBuilder();
	}
	
	/**
	* Default implementation of the EntityIDBuilder-interface.
	*/
	public static class DefaultEntityIDBuilder implements EntityIDBuilder {
    
		private String m_ID;
		private String m_Type;

        public EntityID build() {
            return new DefaultEntityID(this);
        }
