...
/**
 * Default implementation of the NodeInPortEnt-interface. E.g. used if no other {@link EntityBuilderFactory}
 * implementation (provided via the respective extension point, see {@link EntityBuilderManager}) is available.
 *
 * @author Martin Horn, University of Konstanz
 */
public class DefaultNodeInPortEnt implements NodeInPortEnt {
     ...
     * @param builder
     */
    private DefaultNodeInPortEnt(final DefaultNodeInPortEntBuilder builder) {
	...
	public static DefaultNodeInPortEntBuilder builder() {
		return new DefaultNodeInPortEntBuilder();
	}
	
	/**
	* Default implementation of the NodeInPortEntBuilder-interface.
	*/
