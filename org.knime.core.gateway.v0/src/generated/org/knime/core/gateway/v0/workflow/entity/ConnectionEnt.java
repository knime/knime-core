...
public interface ConnectionEnt extends GatewayEntity {
    ...
    /**
     * @return The destination port, starting at 0
     */
 	int getDestPort();
    ...
    /**
     * @return The source port, starting at 0.
     */
 	int getSourcePort();
 	
    /**
     * @return Whether the connection can currently be deleted.
     */
    ...
    /**
     * @return The type of the connection (standard, workflow input / output / through).
     */
 	String getType();
