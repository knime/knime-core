 ...
 */
package org.knime.base.algorithms.outlier.helpers;
...
/**
 * Helper class to extract the data types from a data spec
 *
 * @author Mark Ortmann, KNIME GmbH, Berlin, Germany
 */
public final class Helper4TypeExtraction {
     ...
     */
    public static DataType[] extractTypes(final DataTableSpec inSpec, final String[] columnNames) {
