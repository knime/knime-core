...
public class LeveneTest {
    ...
    private List<Map<Group, SummaryStatistics>> m_gstats;
     ...
     */
    public LeveneTest(final String[] testColumns, final Grouping grouping,
            final List<Map<Group, SummaryStatistics>> gstats) {
        super();
    ...
    public LeveneTestStatistics[] execute(final DataTable table,
        ...
        for (int i = 0; i < testColumnCount; i++) {
            result[i] = new LeveneTestStatistics(m_testColumns[i],
                    m_grouping.getGroupLabels(), m_gstats.get(i));
        }
