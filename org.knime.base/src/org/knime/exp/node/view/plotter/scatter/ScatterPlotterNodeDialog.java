 ...
 */
public class ScatterPlotterNodeDialog extends DefaultNodeDialogPane {
     ...
     */
    public ScatterPlotterNodeDialog() {
        super();

        addDialogComponent(new DialogComponentNumber(
                ScatterPlotterNodeModel.CFGKEY_FROMROW, "First row to display:",
                m_fromMIN, Integer.MAX_VALUE, m_fromSTART));
        addDialogComponent(new DialogComponentNumber(
                ScatterPlotterNodeModel.CFGKEY_ROWCNT,
                "No. of rows to display:", m_cntMIN, Integer.MAX_VALUE,
                m_cntSTART));
        addDialogComponent(new DialogComponentBoolean(
                ScatterPlotterNodeModel.CFG_ANTIALIAS, 
                "Enable Antialiasing",
                false));
    }
}
