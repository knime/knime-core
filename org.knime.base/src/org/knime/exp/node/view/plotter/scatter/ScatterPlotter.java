...
import org.knime.exp.node.view.plotter.columns.TwoColumnPlotter;
...
public class ScatterPlotter extends TwoColumnPlotter {
    ...
    /**
     * 
     * @see org.knime.exp.node.view.plotter.columns.TwoColumnPlotter#
     * updatePaintModel()
     */
    @Override
...
//        getScatterPlotterDrawingPane().clearSelection();
    ...
    /**
     * @see org.knime.exp.node.view.plotter.basic.BasicPlotter#
    ...
    /**
     * 
     * @see org.knime.exp.node.view.plotter.basic.BasicPlotter#clearSelection()
     */
    @Override
