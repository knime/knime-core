...
//            ScatterMatrixPlotter.class);
    ...
    /**
     * @see org.knime.exp.node.view.plotter.scatter.ScatterPlotter#reset()
     */
    @Override
    public void reset() {
        super.reset();
...
//                    dotList.add(dot);
    ...
    /**
     * @see org.knime.exp.node.view.plotter.scatter.ScatterPlotter#sizeChanged()
     */
    @Override
    ...
    public class TransformationMouseListener extends PlotterMouseListener {
        ...
        /**
         * @see org.knime.exp.node.view.plotter.PlotterMouseListener#getCursor()
         */
        @Override
