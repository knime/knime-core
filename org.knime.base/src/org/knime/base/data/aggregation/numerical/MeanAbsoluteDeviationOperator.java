 ...
 * @since 2.12
 */
public class MeanAbsoluteDeviationOperator extends StoreResizableDoubleArrayOperator {
     ...
     * @param opColSettings
     */
    protected MeanAbsoluteDeviationOperator(final OperatorData operatorData, final GlobalSettings globalSettings,
     ...
     */
    public MeanAbsoluteDeviationOperator(final GlobalSettings globalSettings,
        final OperatorColumnSettings opColSettings) {
        this(new OperatorData("Mean absolute deviation", true, false, DoubleValue.class, false), globalSettings,
    ...
    public String getDescription() {
        return "Calculates the mean absolute deviation per group.";
    }
    ...
    public AggregationOperator createInstance(final GlobalSettings globalSettings,
        final OperatorColumnSettings opColSettings) {
        return new MeanAbsoluteDeviationOperator(getOperatorData(), globalSettings, opColSettings);
    }
