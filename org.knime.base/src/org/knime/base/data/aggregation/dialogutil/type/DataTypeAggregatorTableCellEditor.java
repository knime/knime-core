 ...
 * @since 2.11
 */
public class DataTypeAggregatorTableCellEditor
    extends AbstractAggregationFunctionTableCellEditor<AggregationMethod, DataTypeAggregator> {
     ...
     * Constructor.
     */
    public DataTypeAggregatorTableCellEditor() {
     ...
     */
    @Override
    protected AggregationFunction getSelectedAggregationMethod(final JTable table, final DataTypeAggregator value,
     ...
     */
    @Override
    protected DataType getDataType(final JTable table, final DataTypeAggregator value, final boolean isSelected,
