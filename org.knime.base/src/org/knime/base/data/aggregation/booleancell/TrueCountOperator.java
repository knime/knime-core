 ...
 */
public class TrueCountOperator extends AggregationOperator {
     ...
     */
    public TrueCountOperator(
            final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        this(new OperatorData("True Count", "#True", false, false,
     ...
     * @param opColSettings the operator column specific settings
     */
    public TrueCountOperator(final OperatorData operatorData,
            final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
    ...
    public AggregationOperator createInstance(
            final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        return new TrueCountOperator(globalSettings, opColSettings);
    }
    ...
    public String getDescription() {
        return "Counts the members with a TRUE value per group.";
    }
}