 ...
 */
public class BitVectorUnionOperator extends AggregationOperator {
     ...
     */
    public BitVectorUnionOperator(final GlobalSettings globalSettings, final OperatorColumnSettings opColSettings) {
        this(new OperatorData("Bit vector union", "BV union", false, false, BitVectorValue.class, false),
     ...
     * @param opColSettings the operator column specific settings
     */
    public BitVectorUnionOperator(final OperatorData operatorData, final GlobalSettings globalSettings,
    ...
    public AggregationOperator createInstance(final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        return new BitVectorUnionOperator(globalSettings, opColSettings);
    }
    ...
    public String getDescription() {
        return "Computes the union of the bit vectors per group.";
    }
}
