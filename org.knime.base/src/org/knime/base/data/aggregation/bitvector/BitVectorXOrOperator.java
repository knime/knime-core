...
public class BitVectorXOrOperator extends AggregationOperator {
    ...
    private DenseBitVectorCellFactory m_v = null;
    private DenseBitVectorCellFactory m_allSetBits = null;

    /**Constructor for class TrueCountOperator.
     * @param globalSettings the global settings
     * @param opColSettings the operator column specific settings
     */
    public BitVectorXOrOperator(final GlobalSettings globalSettings,
        final OperatorColumnSettings opColSettings) {
        this(new OperatorData("Bit vector exclusive-or", "BV exclusive-or", false, false, BitVectorValue.class, false),
     ...
     * @param opColSettings the operator column specific settings
     */
    public BitVectorXOrOperator(final OperatorData operatorData, final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
    ...
    public AggregationOperator createInstance(final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        return new BitVectorXOrOperator(globalSettings, opColSettings);
    }
