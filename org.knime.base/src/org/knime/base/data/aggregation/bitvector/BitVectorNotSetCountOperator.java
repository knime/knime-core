 ...
 */
public class BitVectorNotSetCountOperator extends AggregationOperator {
     ...
     * @param opColSettings the operator column specific settings
     */
    public BitVectorNotSetCountOperator(final OperatorData operatorData, final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
    ...
    public AggregationOperator createInstance(final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        return new BitVectorNotSetCountOperator(globalSettings, opColSettings);
    }
    ...
    public String getDescription() {
        return "Counts the number of not set bits for all members of a group.";
    }
}
