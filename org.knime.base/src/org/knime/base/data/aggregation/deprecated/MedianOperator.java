 ...
 * @deprecated has been replaced by the new {@link org.knime.base.data.aggregation.numerical.MedianOperator} that offers
 *             user-defined behavior when dealing with even lists
 * @since 3.4
 */
@Deprecated
public class MedianOperator extends SortedListCellOperator {
    ...
    public MedianOperator(final GlobalSettings globalSettings,
            final OperatorColumnSettings opColSettings) {
        this(new OperatorData("Median", "Median(deprecated)", "Median", true, false, DoubleValue.class,
