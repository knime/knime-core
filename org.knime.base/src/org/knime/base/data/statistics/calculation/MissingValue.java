...
public class MissingValue extends Statistic {
    ...
    /**
     * @param columns to count missing values
     */
    public MissingValue(final String... columns) {
     ...
     * @return the number of missing values in the given column
     */
    public int getNumberMissingValues(final String column) {
        return m_missingValues[assertIndexForColumn(column)];
    }
}
