...
public class ZeroNumber extends Statistic {
    ...
    protected void init(final DataTableSpec spec, final int amountOfColumns) {
        m_zeros = new int[amountOfColumns];
    }
     ...
     * @return the number of zero values in the given column
     */
    public int getNumberZeroValues(final String column) {
         return m_zeros[assertIndexForColumn(column)];
    }
}