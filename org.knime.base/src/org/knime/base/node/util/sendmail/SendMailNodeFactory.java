...
public final class SendMailNodeFactory extends NodeFactory<SendMailNodeModel> {
    ...
    /** {@inheritDoc} */
    @Override
    public SendMailNodeModel createNodeModel() {
        return new SendMailNodeModel();
    }

    /** {@inheritDoc} */
    @Override
    public NodeView<SendMailNodeModel> createNodeView(final int viewIndex, final SendMailNodeModel nodeModel) {
        return null;
    }
