...
/**
 * @deprecated use {@link org.knime.core.util.tokenizer.Comment} instead. Will
...
public class Comment {
     ...
     * object is then used to construct a new <code>Comment</code> this and the
     * new object should be identical.
     *
    ...
    /**
     * @return <code>true</code> if this comment will be included in the current
     *         token.
     */
