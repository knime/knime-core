...
public class ListFilesSettings {
    ...
    public static final String LOCATION_SETTINGS = "file_location";

    /** Key to store the RECURSIVE_SETTINGS. */
    public static final String RECURSIVE_SETTINGS = "list_recursive";

    /** Key to store the Filter Settings. */
    public static final String FILTER_SETTINGS = "filter_panel_settings";

    /** Key to store the case sensitive settings. */
    public static final String CASE_SENSITIVE_STRING = "case_sensitive";
