 ...
 * @since 2.11
 */
public class DBDataTypeAggregationFunctionRowTableCellEditor
    extends AbstractAggregationFunctionTableCellEditor<DBAggregationFunction, DBDataTypeAggregationFunctionRow> {
     ...
     */
    public DBDataTypeAggregationFunctionRowTableCellEditor(
    ...
    protected AggregationFunction getSelectedAggregationMethod(final JTable table,
        final DBDataTypeAggregationFunctionRow row, final boolean isSelected, final int rowIdx,
        final int column) {
     ...
     */
    @Override
    protected DataType getDataType(final JTable table, final DBDataTypeAggregationFunctionRow row,
