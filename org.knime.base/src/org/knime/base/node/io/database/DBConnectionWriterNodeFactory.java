 ...
 */
public class DBConnectionWriterNodeFactory 
        extends GenericNodeFactory<DBConnectionWriterNodeModel> {
     ...
     */
    @Override
    public GenericNodeView<DBConnectionWriterNodeModel> createNodeView(
