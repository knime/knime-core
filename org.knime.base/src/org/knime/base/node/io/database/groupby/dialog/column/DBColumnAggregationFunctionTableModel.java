 ...
 */
public class DBColumnAggregationFunctionTableModel
    extends AbstractAggregationTableModel<DBAggregationFunction, DBColumnAggregationFunctionRow> {
     ...
     * Constructor.
     */
    public DBColumnAggregationFunctionTableModel() {
        this(null);
    }
    /**Constructor for class AggregationColumnTableModel.
     * @param provider {@link AggregationFunctionProvider}
     */
    public DBColumnAggregationFunctionTableModel(final AggregationFunctionProvider<DBAggregationFunction> provider) {
        super(new String[] {"Column", "Aggregation (click to change)"},
            new Class<?>[] {DBColumnAggregationFunctionRow.class, DBColumnAggregationFunctionRow.class}, false,
            provider);
    }
     ...
     */
    private boolean isCompatible(final int row, final DataType type) {
        final DBColumnAggregationFunctionRow colAggr = getRow(row);
        return type.isASuperTypeOf(colAggr.getColumnSpec().getType());
    }
     ...
     * @param function the {@link DBColumnAggregationFunctionRow} to use
     */
    private void updateFunction(final int row, final AggregationFunction function) {
        final DBColumnAggregationFunctionRow old = getRow(row);
