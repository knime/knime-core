...
final class DBUpdateNodeModel extends NodeModel {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        DatabaseWriterConnection.updateTable(m_loginConfig, m_tableName, inTable,
            setIncludes, whereIncludes, updateStatus, exec, getCredentialsProvider());
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        ...
        // save table name
        settings.addString("table_name", m_tableName);
        // save SET columns
        if (m_configSET != null) {
    ...
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        // load table name
        m_tableName = settings.getString("table_name").trim();
    }
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        // validate table name
        final String tableName = settings.getString("table_name");
