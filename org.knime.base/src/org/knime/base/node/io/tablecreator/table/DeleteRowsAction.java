...
class DeleteRowsAction extends AbstractAction {
    private static final long serialVersionUID = 8897228659886258633L;
     ...
     */
    DeleteRowsAction(final SpreadsheetTable table) {
        super("Delete Rows");
        m_table = table;
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        ((SpreadsheetTableModel)m_table.getModel()).deleteRows(rows);
    }
