 ...
 */
final class WritePNGNodeDialogPane extends DefaultNodeSettingsPane {

    /**
     *
     */
    WritePNGNodeDialogPane() {
        SettingsModelString fileOutSettings =
            WritePNGNodeModel.createFileOutSettings();
        FlowVariableModel fvmModel =
            super.createFlowVariableModel(fileOutSettings);
        SettingsModelBoolean overwriteOKSettings =
            WritePNGNodeModel.createOverwriteOKSettings();
