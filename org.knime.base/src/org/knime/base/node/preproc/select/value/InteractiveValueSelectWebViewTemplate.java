...
public class InteractiveValueSelectWebViewTemplate implements WebViewTemplate {
    ...
    public WebResourceLocator[] getWebResources() {
        WebResourceLocator locator = new WebResourceLocator("org.knime.base", "js-lib/node/preprocess/select/value/web-template.js", WebResourceType.JAVASCRIPT);
        return new WebResourceLocator[]{locator};
    }
