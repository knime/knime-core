...
public abstract class AbstractCorrelationComputeNodeView<M extends NodeModel> extends NodeView<M>{
     ...
     * @param nodeModel the correlation compute node model
     */
    protected AbstractCorrelationComputeNodeView(final M nodeModel) {
        super(nodeModel);
    ...
    /**
     * @return the {@link TableContentModel} of the internal model
     */
    protected TableContentModel getTableViewContentModel() {
        return m_tableView.getContentModel();
    }

    /**
     * @param height set the row height for the {@link TableView}
     */
    protected void setTableViewRowHeight(final int height) {
        m_tableView.setRowHeight(height);
    }

    /**
     * @return The ID of the current renderer
     */
    protected String getCurrentRendererID() {
