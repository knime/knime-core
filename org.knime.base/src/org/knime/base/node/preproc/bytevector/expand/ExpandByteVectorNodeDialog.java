 ...
 * ---------------------------------------------------------------------
 *
 * Created on 2014.01.17. by gabor
 */
package org.knime.base.node.preproc.bytevector.expand;
...
/**
 * <code>NodeDialog</code> for the "ExpandByteVector" Node. Expands the byte vector to individual integer columns.
 *
 * @author Gabor Bakos
 * @since 2.10
 */
public class ExpandByteVectorNodeDialog extends DefaultNodeSettingsPane {

    /**
     * New pane for configuring the ExpandByteVector node.
     */
    protected ExpandByteVectorNodeDialog() {
        createNewGroup("Input");
        @SuppressWarnings("unchecked")
        final DialogComponentColumnNameSelection input =
            new DialogComponentColumnNameSelection(ExpandVectorNodeModel.createInputColumn(), "Byte vector column", 0,
                true, false, ByteVectorValue.class);
        ...
        addDialogComponent(new DialogComponentString(ExpandByteVectorNodeModel.createOutputPrefix(),
