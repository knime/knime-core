...
/**
 * This is the model implementation of ExpandByteVector. Expands the byte vector to individual integer columns.
 *
 * @author Gabor Bakos
 * @since 2.10
 */
public class ExpandByteVectorNodeModel extends ExpandVectorNodeModel {
    private static final IntCell[] VALUES = new IntCell[256];
    static {
        for (int i = 256; i-- > 0;) {
            VALUES[i] = new IntCell(i);
        }
    }
    private static final String DEFAULT_OUTPUT_PREFIX = "byte vector";
