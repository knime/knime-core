...
/**
 * <code>NodeDialog</code> for the "CreateByteVector" Node.
 ...
 * @since 2.10
 */
public class CreateByteVectorNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected CreateByteVectorNodeDialog() {
        ...
        closeCurrentGroup();
        addDialogComponent(new DialogComponentString(CreateByteVectorNodeModel.createOutputColumn(), "Output column: ", true, 30));
    }
}
