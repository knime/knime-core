...
public final class EditNominalDomainNodeFactory extends NodeFactory<EditNominalDomainNodeModel> {
     ...
     */
    @Override
    public EditNominalDomainNodeModel createNodeModel() {
        return new EditNominalDomainNodeModel();
    }
     ...
     */
    @Override
    public NodeView<EditNominalDomainNodeModel> createNodeView(final int viewIndex,
        final EditNominalDomainNodeModel nodeModel) {
