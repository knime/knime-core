 ...
 */
class UrlToFilePathNodeDialog extends DefaultNodeSettingsPane {
    ...
    /**
     * Creates new instance of <code>UrlToFilePathNodeDialog</code>.
     */
    @SuppressWarnings("unchecked")
    UrlToFilePathNodeDialog() {
        
        // COLUMN SELECTION
        createNewGroup("Column selection");
        addDialogComponent(new DialogComponentColumnNameSelection(
                getStringColModel(), "Column containing URLs", 0, 
                StringValue.class));
        closeCurrentGroup();
