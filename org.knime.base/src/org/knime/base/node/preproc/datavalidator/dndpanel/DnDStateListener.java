...
public interface DnDStateListener {
    ...
    /**
     * Called if a drag started in a {@link DnDConfigurationSubPanel} instance.
     *
     * @param location of the mouse on the screen.
     * @param transferable the object to drag
     */
    public void dragStartedAt(Point location, Transferable transferable);

    /**
     * Called if the drag and drop procedure has been finished.
     */
    public void dragStoppedAt();
}
