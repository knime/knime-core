 ...
 * @author ohl, KNIME
 */
class ChopperCollectionCellFactory extends AbstractCellFactory {
     ...
     */
    public ChopperCollectionCellFactory(final DataTableSpec inSpec, final String colName, final String newColName,
    ...
    public DataCell[] getCells(final DataRow row) {
        ...
        if (col.isMissing()) {
            ...
            result = CollectionCellFactory.createListCell(Arrays.asList(items));
    ...
    public DataColumnSpec[] getColumnSpecs() {
        ...
        DataCell item = m_itemType.isASuperTypeOf(StringCellFactory.TYPE) ? StringCellFactory.create("")
            : DoubleCellFactory.create(0.0);
        ListCell fakeCollection = CollectionCellFactory.createListCell(Collections.singleton(item));
        DataColumnSpecCreator colCreator;
        colCreator = new DataColumnSpecCreator(colName, DataType.getType(fakeCollection.getClass(), item.getType()));
