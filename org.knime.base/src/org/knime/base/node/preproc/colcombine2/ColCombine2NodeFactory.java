 ...
 */
public class ColCombine2NodeFactory extends NodeFactory<ColCombine2NodeModel> {
    ...
    public ColCombine2NodeModel createNodeModel() {
        return new ColCombine2NodeModel();
    }
     ...
     */
    @Override
    public NodeView<ColCombine2NodeModel> createNodeView(final int viewIndex,
            final ColCombine2NodeModel nodeModel) {
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new ColCombine2NodeDialog();
    }
