 ...
 */
public class NumberToCategoryApplyNodeModel extends NodeModel {
    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(NumberToCategoryApplyNodeModel.class);

    private final NumberToCategoryApplyNodeSettings m_settings;

    /**
     * Create new instance.
     */
    public NumberToCategoryApplyNodeModel() {
        super(new PortType[] {PMMLPortObject.TYPE, BufferedDataTable.TYPE},
                new PortType[] {PMMLPortObject.TYPE, BufferedDataTable.TYPE});
        m_settings = new NumberToCategoryApplyNodeSettings();
    }
    ...
    private ColumnRearranger createRearranger(final DataTableSpec spec,
        ...
        for (String col : mapValues.keySet()) {
            ...
            NumberToCategoryApplyCellFactory factory =
                new NumberToCategoryApplyCellFactory(spec,
                        col, m_settings, map);
    ...
    private Map<String, DerivedField> getMapValues(final PMMLPortObject model) {
        Map<String, DerivedField> mapValues =
            new LinkedHashMap<String, DerivedField>();
    ...
    protected void validateSettings(final NodeSettingsRO settings)
            throws InvalidSettingsException {
        new NumberToCategoryApplyNodeSettings().loadSettingsForModel(settings);
    }
