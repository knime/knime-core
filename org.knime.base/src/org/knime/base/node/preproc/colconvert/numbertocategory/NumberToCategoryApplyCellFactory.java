 ...
 */
public class NumberToCategoryApplyCellFactory implements CellFactory {
    private final DataColumnSpec[] m_columnSpecs;
    private final int m_index;
    private final Map<DataCell, String> m_categories;
     ...
     */
    public NumberToCategoryApplyCellFactory(
            final DataTableSpec inSpec, final String colName,
            final NumberToCategoryApplyNodeSettings settings,
        ...
        m_categories = new HashMap<DataCell, String>();
        if (null != mapValues) {
            String in = mapValues.getFieldColumnPairList().get(0).getColumn();
            ...
            for (Row row : table.getRowList()) {
                ...
                m_categories.put(new IntCell(Integer.parseInt(outValue)), inValue);
    ...
    public DataCell[] getCells(final DataRow row) {
        ...
        String value = m_categories.get(cell);
        if (value == null) {
            return m_defaultValue;
        }
        return new DataCell[]{new StringCell(value)};
    }
