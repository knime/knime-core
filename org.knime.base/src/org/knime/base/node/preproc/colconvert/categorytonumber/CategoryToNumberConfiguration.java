 ...
 * @author Heiko Hofer
 */
public class CategoryToNumberConfiguration extends MapValuesConfiguration {
     ...
     *        cell
     */
    public CategoryToNumberConfiguration(final String inColumn,
            final String outColumn,
            final Map<DataCell, IntCell> map, final DataCell defaultValue,
            final DataCell mapMissingTo) {
        super(inColumn, outColumn, map, defaultValue, mapMissingTo);
    }
    ...
    public String getSummary() {
        return "Generated by KNIME - Category2Number node";
    }
