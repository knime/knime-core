...
public class CategoryToNumberNodeSettings {
    ...
    /** filter configuration for DataColumnSpecFilterPanel. */
    ...
    public CategoryToNumberNodeSettings() {
        m_filterConfiguration = CategoryToNumberNodeModel.createDCSFilterConfiguration();
    ...
    /**
     * @return filter configuration for data column spec filter panel
     */
