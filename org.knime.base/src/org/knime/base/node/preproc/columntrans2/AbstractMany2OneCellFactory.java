...
public abstract class AbstractMany2OneCellFactory implements CellFactory {
     ...
     */
    public AbstractMany2OneCellFactory(final DataTableSpec inputSpec, final String appendedColumnName,
        ...
        for (int i : m_includedColsIndices) {
            m_columnNames.add(new StringCell(m_inputSpec.getColumnSpec(i).getName()));
        }
    }
