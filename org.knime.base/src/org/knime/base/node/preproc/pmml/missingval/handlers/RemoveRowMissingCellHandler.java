...
public class RemoveRowMissingCellHandler extends DefaultMissingCellHandler {
     ...
     */
    public RemoveRowMissingCellHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public DerivedField getPMMLDerivedField() {
        return createExtensionDerivedField(getPMMLDataTypeForColumn(), RemoveRowMissingCellHandlerFactory.ID);
    }
