...
public class FixedDoubleValueMissingCellHandler extends MissingCellHandler {
    ...
    public static SettingsModelDouble createDoubleValueSettingsModel() {
        return new SettingsModelDouble(FIX_VAL_CFG, 0.0);
    }

    private SettingsModelDouble m_fixVal = createDoubleValueSettingsModel();

    /**
     * @param col the column this handler is configured for
     */
    public FixedDoubleValueMissingCellHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public DataCell getCell(final RowKey key, final DataColumnWindow window) {
        return new DoubleCell(m_fixVal.getDoubleValue());
    }
