...
public interface MissingCellHandlerDescription {
    /**
     * @return the name of the missing cell handler
     */
    String getName();

    /**
     * @return a one line string with a short description of the missing cell handler
     */
    ...
    /**
     * @return the missing cell handler DOM tree
     */
    Element getElement();
}
