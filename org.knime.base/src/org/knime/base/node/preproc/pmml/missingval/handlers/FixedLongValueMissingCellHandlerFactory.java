 ...
 */
public class FixedLongValueMissingCellHandlerFactory extends MissingCellHandlerFactory {
    ...
    public MissingValueHandlerPanel getSettingsPanel() {
        return new FixedLongValuePanel();
    }
    ...
    public MissingCellHandler createHandler(final DataColumnSpec column) {
        return new FixedLongValueMissingCellHandler(column);
    }
    ...
    public boolean isApplicable(final DataType type) {
        return type.equals(LongCell.TYPE);
    }
