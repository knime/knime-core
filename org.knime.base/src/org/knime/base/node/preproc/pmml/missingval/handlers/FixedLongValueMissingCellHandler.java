...
public class FixedLongValueMissingCellHandler extends DefaultMissingCellHandler {
    ...
    private SettingsModelLong m_fixVal = createLongValueSettingsModel();

    /**
     * @param col the column this handler is configured for
     */
    public FixedLongValueMissingCellHandler(final DataColumnSpec col) {
        super(col);
    }
    ...
    public DataCell getCell(final RowKey key, final DataColumnWindow window) {
        return new LongCell(m_fixVal.getLongValue());
    }
