...
final class RenameColumn2Panel extends JPanel {
    ...
    private final RenameColumn2Setting m_settings;
    ...
    RenameColumn2Panel(final RenameColumn2Setting colSet, final DataColumnSpec spec) {
     ...
     * @return the settings
     */
    RenameColumn2Setting getSettings() {
        return m_settings;
    }
