 ...
 */
final class RenameColumn2Setting {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(RenameColumn2Setting.class);
     ...
     */
    RenameColumn2Setting(final String name) {
        m_name = name;
    ...
    RenameColumn2Setting(final DataColumnSpec column) {
     ...
     * @throws InvalidSettingsException if that fails
     */
    static RenameColumn2Setting createFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        RenameColumn2Setting result = new RenameColumn2Setting(name);
