 ...
 */
package org.knime.base.node.preproc.filter.definition.apply.rowsplitter;
 ...
 */
public class FilterApplyRowSplitterNodeModel extends NodeModel {

    /**
     * One data table and one {@link FilterDefinitionHandlerPortObject} as input, two data tables as output.
     */
    protected FilterApplyRowSplitterNodeModel() {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        final BufferedDataTableRowOutput out1 = new BufferedDataTableRowOutput(
            exec.createDataContainer(((BufferedDataTable)inObjects[0]).getDataTableSpec()));
        final BufferedDataTableRowOutput out2 = new BufferedDataTableRowOutput(
            exec.createDataContainer(((BufferedDataTable)inObjects[0]).getDataTableSpec()));
        execute(new DataTableRowInput((BufferedDataTable)inObjects[0]), out1, out2, filterSpec, exec,
     ...
     */
    private  void execute(final RowInput inData, final RowOutput output1, final RowOutput output2,
        final DataTableSpec filterSpec, final ExecutionContext exec, final long rowCount) throws Exception {
        DataRow row;
