 ...
 * @author KNIME GmbH
 */
public class NominalValueRowFilterNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "org.knime.ext.bia.row";

    // The shared instance.
    private static NominalValueRowFilterNodePlugin plugin;
