...
public class EndcaseNodeDialog extends NodeDialogPane {
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        boolean appendSuffix = settings.getBoolean(
                EndcaseNodeModel.CFG_APPEND_SUFFIX, false);
        String suffix = settings.getString(EndcaseNodeModel.CFG_SUFFIX,
                "x");
        if (appendSuffix) {
        ...
        m_enableHiliting.setSelected(settings.getBoolean(
                EndcaseNodeModel.CFG_HILITING, false));
    }
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        settings.addBoolean(EndcaseNodeModel.CFG_APPEND_SUFFIX, isSuffix);
        settings.addString(EndcaseNodeModel.CFG_SUFFIX, suffix);
        settings.addBoolean(EndcaseNodeModel.CFG_HILITING,
