 ...
 */
public class PMMLClusterNodeView extends GenericNodeView<PMMLClusterNodeModel> 
     ...
     */
    public PMMLClusterNodeView(final PMMLClusterNodeModel nodeModel) {
        super(nodeModel);
     ...
     */
    @Override
    protected PMMLClusterNodeModel getNodeModel() {
        return (PMMLClusterNodeModel) super.getNodeModel();
    }
    ...
    public final void modelChanged() {
        ...
        if (getNodeModel() == null) { // do we even have a NodeModel?
            ...
            // tree
            PMMLClusterNodeModel myModel = (PMMLClusterNodeModel) getNodeModel();
            if (!myModel.hasModel()) {
                ...
                for (int c = 0; c < myModel.getNumClusters(); c++) {
                    ...
                    clusterParent = new ClusterMutableTreeNode(
                            PMMLClusterNodeModel.CLUSTER + c + " (coverage: "
                                    + myModel.getClusterCoverage(c) + ")",
                            new RowKey(PMMLClusterNodeModel.CLUSTER + c));
