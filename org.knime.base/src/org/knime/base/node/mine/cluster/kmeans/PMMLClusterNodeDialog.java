...
/**
 * Dialog for
 * {@link PMMLClusterNodeModel} - allows
 * to adjust number of clusters and other properties.
 * 
 * @author Michael Berthold, University of Konstanz
 */
public class PMMLClusterNodeDialog extends DefaultNodeSettingsPane {
...
//    private final ColumnFilterPanel m_columnFilter;
    ...
    PMMLClusterNodeDialog() {
        super();
        m_nrOfClusters = new DialogComponentNumber(
                new SettingsModelIntegerBounded(
                        PMMLClusterNodeModel.CFG_NR_OF_CLUSTERS, 
                        PMMLClusterNodeModel.INITIAL_NR_CLUSTERS, 
                        1, Integer.MAX_VALUE), "number of clusters: ", 1);
        m_maxNrOfIterations = new DialogComponentNumber(
                new SettingsModelIntegerBounded(
                        PMMLClusterNodeModel.CFG_MAX_ITERATIONS,
                        PMMLClusterNodeModel.INITIAL_MAX_ITERATIONS,
                        1, Integer.MAX_VALUE),
                        "max. number of iterations: ", 10);
        m_columnFilter = new DialogComponentColumnFilter(
                new SettingsModelFilterString(PMMLClusterNodeModel.CFG_COLUMNS), 
                0, DoubleValue.class);
