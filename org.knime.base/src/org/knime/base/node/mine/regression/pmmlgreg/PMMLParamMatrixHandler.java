...
final class PMMLParamMatrixHandler extends PMMLContentHandler {
    ...
    public PMMLParamMatrixHandler(
        ...
        m_content = content;
        m_paramMatrix = new ArrayList<PMMLPCell>();
    }
    ...
    public void endElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            ...
            m_content.setParamMatrix(
                    m_paramMatrix.toArray(new PMMLPCell[0]));
        } else {
    ...
    public void startElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in ParamMatrix: "
                    + name);
        } else if ("PCell".equals(name)) {
            m_contentHandlerStack.push(new PMMLPCellContentHandler(
                    m_contentHandlerStack, atts, m_paramMatrix));
        } else {
            throw new SAXException("Unknown xml element in ParamMatrix: "
                    + name);
        }
    }
