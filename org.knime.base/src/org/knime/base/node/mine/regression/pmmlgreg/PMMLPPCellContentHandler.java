 ...
 * @author Heiko Hofer
 */
final class PMMLPPCellContentHandler  extends PMMLContentHandler {
    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(PMMLPPCellContentHandler.class);

    private Stack<PMMLContentHandler> m_contentHandlerStack;
    private List<PMMLPPCell> m_ppCellList;
    private PMMLPPCell m_ppCell;

    /**
     * @param contentHandlerStack stack of content handlers
     * @param atts the attributes of a PMMLPPCell
     * @param ppCellList the list is used to store the read PMMLPPCell
     */
    public PMMLPPCellContentHandler(
            final Stack<PMMLContentHandler> contentHandlerStack,
            final Attributes atts,
            final List<PMMLPPCell> ppCellList) {
        m_contentHandlerStack = contentHandlerStack;
        m_ppCellList = ppCellList;

        m_ppCell = new PMMLPPCell(
                atts.getValue("value"),
                atts.getValue("predictorName"),
