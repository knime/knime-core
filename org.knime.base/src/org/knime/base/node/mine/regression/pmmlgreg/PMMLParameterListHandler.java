...
final class PMMLParameterListHandler extends PMMLContentHandler {
    ...
    public PMMLParameterListHandler(
        ...
        m_content = content;
        m_parameterList = new ArrayList<PMMLParameter>();
    }
    ...
    public void endElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            ...
            m_content.setParameterList(
                    m_parameterList.toArray(new PMMLParameter[0]));
        } else {
    ...
    public void startElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in ParameterList: "
                    + name);
        } else if ("Parameter".equals(name)) {
            m_contentHandlerStack.push(new PMMLParameterContentHandler(
                    m_contentHandlerStack, atts, m_parameterList));
        } else {
            throw new SAXException("Unknown xml element in ParameterList: "
                    + name);
        }
    }
