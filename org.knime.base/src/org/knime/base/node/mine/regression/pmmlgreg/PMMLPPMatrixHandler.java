...
final class PMMLPPMatrixHandler extends PMMLContentHandler {
    ...
    public PMMLPPMatrixHandler(
        ...
        m_content = content;
        m_ppMatrix = new ArrayList<PMMLPPCell>();
    }
    ...
    public void endElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            ...
            m_content.setPPMatrix(
                    m_ppMatrix.toArray(new PMMLPPCell[0]));
        } else {
    ...
    public void startElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in PPMatrix: "
                    + name);
        } else if ("PPCell".equals(name)) {
            m_contentHandlerStack.push(new PMMLPPCellContentHandler(
                    m_contentHandlerStack, atts, m_ppMatrix));
        } else {
            throw new SAXException("Unknown xml element in PPMatrix: "
                    + name);
        }
    }
