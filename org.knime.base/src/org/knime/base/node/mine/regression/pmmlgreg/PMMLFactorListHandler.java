...
final class PMMLFactorListHandler extends PMMLContentHandler {
    ...
    public PMMLFactorListHandler(
        ...
        m_content = content;
        m_factorList = new ArrayList<PMMLPredictor>();
    }
    ...
    public void endElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            ...
            m_content.setFactorList(
                    m_factorList.toArray(new PMMLPredictor[0]));
        } else {
    ...
    public void startElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in FactorList: "
                    + name);
        } else if ("Predictor".equals(name)) {
            m_contentHandlerStack.push(new PMMLPredictorContentHandler(
                    m_contentHandlerStack, atts, m_factorList));
        } else {
            throw new SAXException("Unknown xml element in FactorList: "
                    + name);
        }
    }
