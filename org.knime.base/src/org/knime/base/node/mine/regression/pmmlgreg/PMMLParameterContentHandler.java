 ...
 * @author Heiko Hofer
 */
final class PMMLParameterContentHandler  extends PMMLContentHandler {
    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(PMMLParameterContentHandler.class);

    private Stack<PMMLContentHandler> m_contentHandlerStack;
    private List<PMMLParameter> m_parameterList;
    private PMMLParameter m_parameter;

    /**
     * @param contentHandlerStack stack of content handlers
     * @param atts the attributes of a PMMLParameter
     * @param parameterList the list is used to store the read parameter
     */
    public PMMLParameterContentHandler(
            final Stack<PMMLContentHandler> contentHandlerStack,
            final Attributes atts,
            final List<PMMLParameter> parameterList) {
        ...
        if (null == label) {
            m_parameter = new PMMLParameter(name);
        } else {
            m_parameter = new PMMLParameter(name, label);
        }
    }
