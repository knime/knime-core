...
/**
 * Properties for the {@link LinReg2LinePlotter} which ensures
 ...
 *
 */
public class LinReg2LinePlotterProperties extends ScatterPlotterProperties {

    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(LinReg2LinePlotterProperties.class);
     ...
     * contains only the columns used for the model calculation.
     *
     */
    public LinReg2LinePlotterProperties() {
