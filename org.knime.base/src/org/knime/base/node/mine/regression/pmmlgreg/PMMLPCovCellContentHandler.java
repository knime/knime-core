 ...
 * @author Heiko Hofer
 */
final class PMMLPCovCellContentHandler extends PMMLContentHandler {
    private static final NodeLogger LOGGER =
        NodeLogger.getLogger(PMMLPCovCellContentHandler.class);

    private Stack<PMMLContentHandler> m_contentHandlerStack;
    private List<PMMLPCovCell> m_pCovCellList;
    private PMMLPCovCell m_pCovCell;

    /**
     * @param contentHandlerStack stack of content handlers
     * @param atts the attributes of a PMMLPCovCell
     * @param pCovCellList the list is used to store the read PMMLPCovCell
     */
    public PMMLPCovCellContentHandler(
            final Stack<PMMLContentHandler> contentHandlerStack,
            final Attributes atts,
            final List<PMMLPCovCell> pCovCellList) {
        m_contentHandlerStack = contentHandlerStack;
        m_pCovCellList = pCovCellList;

        double value = Double.valueOf(atts.getValue("value"));
        m_pCovCell = new PMMLPCovCell(
                atts.getValue("pRow"),
                atts.getValue("pCol"),
                atts.getValue("tRow"),
                atts.getValue("tCol"),
