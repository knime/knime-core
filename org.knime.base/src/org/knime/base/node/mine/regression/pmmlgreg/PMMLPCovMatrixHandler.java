...
final class PMMLPCovMatrixHandler extends PMMLContentHandler {
    ...
    public PMMLPCovMatrixHandler(
        ...
        m_content = content;
        m_pCovMatrix = new ArrayList<PMMLPCovCell>();
    }
    ...
    public void endElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            ...
            m_content.setPCovMatrix(
                    m_pCovMatrix.toArray(new PMMLPCovCell[0]));
        } else {
    ...
    public void startElement(final String uri, final String localName,
        ...
        if ("Extension".equals(name)) {
            LOGGER.debug("Skipping unknown extension in PCovMatrix: "
                    + name);
        } else if ("PCovCell".equals(name)) {
            m_contentHandlerStack.push(new PMMLPCovCellContentHandler(
                    m_contentHandlerStack, atts, m_pCovMatrix));
        } else {
            throw new SAXException("Unknown xml element in PCovMatrix: "
                    + name);
        }
    }
