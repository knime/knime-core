 ...
 */
public class FuzzyBasisFunctionLearnerNodeView extends 
        BasisFunctionLearnerNodeView<FuzzyBasisFunctionLearnerNodeModel> {

    /**
     * Create fuzzy learner node view.
     * @param model fuzzy learner node model
     */
    public FuzzyBasisFunctionLearnerNodeView(
            final FuzzyBasisFunctionLearnerNodeModel model) {
        super(model);
    }
}
