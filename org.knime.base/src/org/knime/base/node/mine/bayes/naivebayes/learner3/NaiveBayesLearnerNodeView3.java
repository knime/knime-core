...
final class NaiveBayesLearnerNodeView3 extends NodeView<NaiveBayesLearnerNodeModel3> {
     ...
     * Creates a new view.
     *
     * @param nodeModel The model ( class: <code>NaiveBayesLearnerNodeModel</code>)
     */
    protected NaiveBayesLearnerNodeView3(final NaiveBayesLearnerNodeModel3 nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        final NaiveBayesLearnerNodeModel3 nodeModel = getNodeModel();
        m_model = nodeModel.getNaiveBayesModel();
        if (m_model != null) {
