...
public final class NaiveBayesPredictorNodeModel3 extends NodeModel {
     ...
     */
    public NaiveBayesPredictorNodeModel3() {
    ...
    private ColumnRearranger createColumnRearranger(final PMMLPortObject pmmlPortObj, final DataTableSpec inSpec) {
        ...
        if (!model.hasStablePMMLThreshold()) {
            setWarningMessage("The PMML model's default probability threshold is zero, which "
        ...
        final String predictionColName = m_overridePredicted.getBooleanValue() ? m_predictionColumnName.getStringValue()
    ...
    public StreamableOperator createStreamableOperator(final PartitionInfo partitionInfo,
        ...
        return new StreamableOperator() {
            ...
            public void runFinal(final PortInput[] inputs, final PortOutput[] outputs, final ExecutionContext exec)
                ...
                StreamableFunction fct =
                    createColumnRearranger(pmmlPortObj, inSpec).createStreamableFunction(DATA_IN_PORT, 0);
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        final DataColumnSpec resultColSpecs = NaiveBayesCellFactory.createResultColSpecs(
            predictorHelper.checkedComputePredictionColumnName(m_predictionColumnName.getStringValue(),
                m_overridePredicted.getBooleanValue(), classColumn.getName()),
