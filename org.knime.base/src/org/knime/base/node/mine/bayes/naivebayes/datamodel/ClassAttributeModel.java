...
class ClassAttributeModel extends AttributeModel {
     ...
     *</dl>
     */
    private final Map<String, ExtendedInteger> m_recsCounterByClassVal;
    ...
    ClassAttributeModel(final String rowCaption, 
        ...
        m_recsCounterByClassVal = 
            new HashMap<String, ExtendedInteger>(maxNoOfClassVals);
    }
    ...
    ClassAttributeModel(final String attributeName, 
        ...
        m_recsCounterByClassVal = 
            new HashMap<String, ExtendedInteger>(classVals.length);
    ...
    void saveModelInternal(final Config config) {
        ...
        int i = 0;
        for (String classVal : m_recsCounterByClassVal.keySet()) {
    ...
    void addValueInternal(final String classValue, 
        ...
        ExtendedInteger classCounter = m_recsCounterByClassVal.get(classValue);
        if (classCounter == null) {
            ...
            classCounter = new ExtendedInteger();
    ...
    Integer getNoOfRecs4ClassValue(final String classValue) {
        final ExtendedInteger noOfRecs = 
    ...
    @Override
    String getHTMLView() {
        return AttributeModel.createHTMLTable(null, "Class value: ", 
