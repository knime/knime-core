...
public class NaiveBayesLearnerNodeDialog3 extends DefaultNodeSettingsPane {
    ...
    public NaiveBayesLearnerNodeDialog3() {
        super();
        ...
        final SettingsModelString columnName = NaiveBayesLearnerNodeModel3.createClassifyColumnModel();
        ...
        final DialogComponentNumber laplaceCorrectorComponent =
            new DialogComponentNumber(m_threshold, "Default probability: ", new Double(0.001), 5);
        ...
        maxNomVals
            .setToolTipText("Nominal attributes with more than " + "the specified number of unique values are skipped");
        ...
        final DialogComponentBoolean pmmlComp =
            new DialogComponentBoolean(m_pmmlCompatible, "Create PMML 4.2 compatible model");
