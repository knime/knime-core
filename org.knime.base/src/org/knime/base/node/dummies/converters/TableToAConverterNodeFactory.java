...
import org.knime.base.node.dummies.a.APortObjectSpec;
 ...
 * @author hornm
 */
public class TableToAConverterNodeFactory extends ConverterNodeFactory<ConverterNodeModel>{
    ...
    public ConverterNodeModel createNodeModel() {
        return new ConverterNodeModel(BufferedDataTable.TYPE, APortObject.TYPE) {
