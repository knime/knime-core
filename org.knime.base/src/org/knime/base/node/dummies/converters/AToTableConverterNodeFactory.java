 ...
 * @author hornm
 */
public class AToTableConverterNodeFactory extends ConverterNodeFactory<ConverterNodeModel>{
    ...
    public ConverterNodeModel createNodeModel() {
        return new ConverterNodeModel(APortObject.TYPE, BufferedDataTable.TYPE) {
