...
public class XValidateModel extends MetaNodeModel {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        ColumnRearranger colRePort0 = m_aggregateModel.
            createColumnRearrangerPort0(inData[0].getDataTableSpec());
        BufferedDataTable outPort0 = exec.createColumnRearrangeTable(
                inData[0], colRePort0, exec.createSubProgress(0.0));
        BufferedDataTable outPort1 = m_aggregateModel.createOutputPort1(exec);
        return new BufferedDataTable[]{outPort0, outPort1};
    }

    /**
     * @see SpecialNodeModel#validateSettings(File, NodeSettingsRO)
     */
    @Override
    ...
    /**
     * @see SpecialNodeModel#loadValidatedSettingsFrom(File, NodeSettingsRO,
     *      ExecutionMonitor)
     */
    @Override
    protected void loadValidatedSettingsFrom(final File nodeDir,
        ...
        if (internals.exists()) {
            ...
            try {
                m_aggregateNode = internalWFM().getNodeContainerById(
    ...
    /**
     * @see SpecialNodeModel#saveSettingsTo(
    ...
    protected void addInternalConnections() {
        ...
        internalWFM().addConnection(
                m_aggregateNode.getID(), 1, dataOutNodeContainer(1).getID(), 0);
    }
