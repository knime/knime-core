...
public class FeatureSelectionLoopStartSettings {
    private static final String CFG_CONSTANT_COLUMNS = "constantColumns";

    private static final String CFG_CONSTANT_COLUMNS_FILTER_CONFIG = "constantColumnsFilterConfig";

    private static final String CFG_SELECTION_STRATEGY = "selectionStrategy";

    private static final String CFG_NR_FEATURES_THRESHOLD = "nrFeatureThreshold";

    private static final String[] DEF_CONSTANT_COLUMNS = new String[0];
    ...
    public DataColumnSpecFilterConfiguration getConstantColumnsFilterConfiguration() {
