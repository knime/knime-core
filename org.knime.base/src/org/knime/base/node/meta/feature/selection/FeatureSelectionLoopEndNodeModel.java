...
public class FeatureSelectionLoopEndNodeModel extends NodeModel implements LoopEndNode {
    ...
    public FeatureSelectionLoopEndNodeModel() {
        super(new PortType[]{FlowVariablePortObject.TYPE}, new PortType[]{FeatureSelectionModel.TYPE});
    }
    ...
    protected PortObjectSpec[] configure(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        if (!getAvailableInputFlowVariables().containsKey(scoreVariableName)) {
            throw new InvalidSettingsException("The defined score variable \"" + scoreVariableName
                + "\" is not contained in the input flowvariables.");
        }
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        m_selectionStrategy.addScore(score);

        m_iteration++;
        if (m_selectionStrategy.continueLoop()) {
            continueLoop();
            return null;
        }

        return new PortObject[]{m_selectionStrategy.getFeatureSelectionModel()};
    }
