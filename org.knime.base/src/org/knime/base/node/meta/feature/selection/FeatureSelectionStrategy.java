...
public interface FeatureSelectionStrategy {
     ...
     * This needs to happen BEFORE the first loop iteration starts.
     * (Ideally this should be called once in the first configure of the loop start)
     *
     * @param scoreName needed to initialize FeatureSelectionModel
     */
