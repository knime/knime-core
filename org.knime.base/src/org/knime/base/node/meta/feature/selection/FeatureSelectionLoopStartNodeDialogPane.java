...
public class FeatureSelectionLoopStartNodeDialogPane extends NodeDialogPane {
    ...
    private void layout() {
        ...
        panel.add(new JLabel("Select constant columns"), gbc);
        gbc.gridy += 1;
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        ...
        m_constantColumnsFilterPanel.saveConfiguration(cfg.getConstantColumnsFilterConfiguration());
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec[] specs)
        ...
        m_constantColumnsFilterPanel.loadConfiguration(cfg.getConstantColumnsFilterConfiguration(), specs[0]);
