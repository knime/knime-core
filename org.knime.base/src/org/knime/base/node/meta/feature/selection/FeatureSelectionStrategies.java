...
public class FeatureSelectionStrategies {
    ...
    public enum Strategy {
            ...
            BackwardFeatureSelection("Backward Feature Selection", (byte)1);
    ...
    public static FeatureSelectionStrategy createFeatureSelectionStrategy(final Strategy strategy, final int subsetSize,
        final String[] constantColumns, final String[] featureColumns) {
        switch (strategy) {
            case ForwardFeatureSelection:
                return new FFSStrategy(subsetSize, constantColumns, featureColumns);
            case BackwardFeatureSelection:
                return new FBSStrategy(subsetSize, constantColumns, featureColumns);
            default:
