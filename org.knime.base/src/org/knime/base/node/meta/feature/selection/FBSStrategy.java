...
public class FBSStrategy extends AbstractFeatureSelectionStrategy {
    private final List<String> m_included;
    private final List<String> m_available;
    private int m_featurePointer = 0;
    private boolean m_isFirstIteration = true;

    public FBSStrategy(final int subsetSize, final String[] constantColumns, final String[] featureColumns) {
    ...
    protected List<String> getIncludedInThisIteration() {
        final List<String> tempIncl = new LinkedList<>(m_included);
