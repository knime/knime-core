...
public class FeatureSelectionFilterNodeDialog extends NodeDialogPane {
    ...
    private List<String> m_constantColumns;
        ...
        m_includeTargetColumn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (m_includeTargetColumn.isSelected()) {
                    l.addAll(m_constantColumns);
                } else {
                    l.removeAll(m_constantColumns);
                }
    ...
    private void listSelectionChanged(final ListSelectionEvent ev) {
        ...
        if (selRow >= 0) {
            ...
            if (m_includeTargetColumn.isSelected()) {
                features.addAll(m_constantColumns);
            }
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_constantColumns = Arrays.asList(m_fsModel.getConstantColumns());
                ...
                for (int i = 0; i < m_tableModel.getRowCount(); i++) {
                    if (m_settings.thresholdMode()) {
                        if (m_tableModel.getNrOfFeatures(i) == m_settings
                                .includedColumns(m_fsModel).size()) {
