 ...
 */
public class FeatureSelectionLoopStartNodeFactory extends NodeFactory<FeatureSelectionLoopStartNodeModel> {
    ...
    public FeatureSelectionLoopStartNodeModel createNodeModel() {
        return new FeatureSelectionLoopStartNodeModel(1);
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new FeatureSelectionLoopStartNodeDialogPane();
    }
