...
public class ColumnListLoopStartNodeDialog extends NodeDialogPane {
    ...
    private final ColumnFilterPanel m_iterateOverColumns =
            new ColumnFilterPanel(true);
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        m_settings.iterateOverColumn(m_iterateOverColumns
                .getIncludedColumnSet());
        m_settings.alwaysIncludeColumns(m_iterateOverColumns
                .getExcludedColumnSet());
        m_settings.iterateAllColumns(m_iterateOverColumns.isKeepAllSelected());
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_iterateOverColumns.update(specs[0], false, m_settings
                .iterateOverColumns());
        m_iterateOverColumns.setKeepAllSelected(m_settings.iterateAllColumns());
    }
}
