 ...
 * --------------------------------------------------------------------- *
 */
package org.knime.base.node.view.table;
...
import org.knime.base.node.filter.row.RowFilterTable;
import org.knime.base.node.filter.row.rowfilter.EndOfTableException;
import org.knime.base.node.filter.row.rowfilter.IncludeFromNowOn;
