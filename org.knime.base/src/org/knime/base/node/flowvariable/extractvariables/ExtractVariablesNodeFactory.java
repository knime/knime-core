 ...
 */
public class ExtractVariablesNodeFactory 
    extends NodeFactory<ExtractVariablesNodeModel> {
    
    private final PortType m_inOutType;
    
    /** Creates factory for {@link BufferedDataTable} type ports. */
    public ExtractVariablesNodeFactory() {
     ...
     */
    public ExtractVariablesNodeFactory(final PortType inOutType) {
        if (inOutType == null) {
    ...
    /** {@inheritDoc} */
    @Override
    public ExtractVariablesNodeModel createNodeModel() {
        return new ExtractVariablesNodeModel(m_inOutType);
    }

    /** {@inheritDoc} */
    @Override
    public NodeView<ExtractVariablesNodeModel> createNodeView(
            final int index, final ExtractVariablesNodeModel model) {
        return null;
    }
