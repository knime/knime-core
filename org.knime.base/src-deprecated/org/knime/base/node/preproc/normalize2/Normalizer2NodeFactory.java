 ...
 */
package org.knime.base.node.preproc.normalize2;
...
extends NodeFactory<Normalizer2NodeModel> {
     ...
     */
    @Override
    public Normalizer2NodeModel createNodeModel() {
        return new Normalizer2NodeModel();
    }
     ...
     */
    @Override
    public NodeView<Normalizer2NodeModel> createNodeView(
            final int viewIndex, final Normalizer2NodeModel nodeModel) {
        return null;
    }
