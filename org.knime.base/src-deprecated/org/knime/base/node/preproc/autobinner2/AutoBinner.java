...
public class AutoBinner {
     ...
     */
    public AutoBinner(final AutoBinnerLearnSettings settings) throws InvalidSettingsException {
        m_settings = settings;
    }
    ...
    private void addAllNumericCols(final DataTableSpec inSpec) throws InvalidSettingsException {
        ...
        if (!numericCols.isEmpty()) {
            ...
            throw new InvalidSettingsException("No column in " + "spec compatible to \"DoubleValue\".");
        }
    }
    ...
    /**
     * Validates the settings in the passed <code>AutoBinnerLearnSettings</code> object. The specified settings is
     * checked for completeness and consistency.
     *
     * @param settings The settings to validate.
     * @throws InvalidSettingsException If the validation of the settings failed.
     */
    public static void validateSettings(final AutoBinnerLearnSettings settings) throws InvalidSettingsException {
