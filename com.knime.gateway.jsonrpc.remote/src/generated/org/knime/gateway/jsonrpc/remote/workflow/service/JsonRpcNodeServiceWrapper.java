...
public class JsonRpcNodeServiceWrapper implements NodeService {
     ...
     */
    @Override
    @JsonRpcMethod(value = "getNodeSettingsJSON")
    public String getNodeSettingsJSON(@JsonRpcParam(value="rootWorkflowID") final String rootWorkflowID,@JsonRpcParam(value="nodeID") final String nodeID) {
    ...
    public NodeEnt getNode(@JsonRpcParam(value="rootWorkflowID") final String rootWorkflowID,@JsonRpcParam(value="nodeID") final Optional<String> nodeID) {
