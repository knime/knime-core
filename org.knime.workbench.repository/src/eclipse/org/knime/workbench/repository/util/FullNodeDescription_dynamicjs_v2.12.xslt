...
<!-- Stylesheet for node descriptions introduced with dynamic JavaScript nodes in KNIME 2.12 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://knime.org/dynamicnode/v2.12" xmlns:js="http://knime.org/dynamicjsnode/v2.12"
                xmlns="http://www.w3.org/1999/xhtml">
    <xsl:param name="css" />
    <xsl:template match="js:knimeNode">
        <html>
            <head>
                <title>
            ...
            <body>
                ...
                <xsl:if test="t:fullDescription/t:options">
                    <h2>Dialog Options</h2>
                    <dl>
                        <xsl:apply-templates select="t:fullDescription/t:options/*" />
                    </dl>
                </xsl:if>
