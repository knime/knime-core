...
/**
 * Action for saving the definition of a custom repository to a file.
 *
 * @author Thorsten Meinl, University of Konstanz
 */
class SaveDefinitionAction extends Action {
    private final Shell m_shell;

    private final CustomRepositoryManager m_manager;

    SaveDefinitionAction(final Shell shell,
        ...
        setToolTipText("Save definition to file");
    }
    ...
    @Override
    public void run() {
        CustomReposExportWizard wizard = new CustomReposExportWizard(m_manager);
