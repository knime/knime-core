...
enum TestLevel {
    ...
    // Note that the NodeLoggerLoggerAdapter in org.knime.slf4j.binding always returns false on isTraceEnabled.
    // This means, the logger does not support trace level messages at all.

    TEST_DEBUG(//
        Logger::debug, // (these all mean different methods -- Ctrl+click to resolve)
        Logger::debug, //
        Logger::debug, //
        Logger::debug, //
        Logger::debug, //
