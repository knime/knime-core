...
interface LogRegLearner {
     ...
     */
    public LogisticRegressionContent learn(final RegressionTrainingData data, ExecutionMonitor progressMonitor) throws CanceledExecutionException, InvalidSettingsException;
