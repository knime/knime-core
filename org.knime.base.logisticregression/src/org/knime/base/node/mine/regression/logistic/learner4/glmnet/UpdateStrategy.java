...
interface UpdateStrategy {
     ...
     * @param targets the targets that should be used for the intialization
     */
    void initialize(final double[] beta, final double[] targets);

    /**
     * Calculates the updated value of beta for the corresponding feature.
     *
     * @param betaOld the old value of beta
     * @param feature the feature index (zero based)
     * @param alpha elastic net parameter
     * @param lambda weight of regularization in objective function
     * @return the new value for beta
     */
    double update(double betaOld, int feature, double alpha, double lambda);
}
