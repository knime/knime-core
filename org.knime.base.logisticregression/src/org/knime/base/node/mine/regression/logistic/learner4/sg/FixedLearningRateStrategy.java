 ...
 */
class FixedLearningRateStrategy<T extends TrainingRow> implements LearningRateStrategy<T> {

    private final double m_learningRate;

    /**
     * @param learningRate the fixed learning rate to use during the entire algorithm
     *
     */
    public FixedLearningRateStrategy(final double learningRate) {
