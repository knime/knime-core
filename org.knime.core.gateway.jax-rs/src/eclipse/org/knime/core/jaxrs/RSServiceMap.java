...
/**
 * Maps api gateway services to the rest service interfaces (those with the JAX-RS annotations).
 *
...
public class RSServiceMap extends ServiceMap<Class<GatewayService>> {
     ...
     */
    public static final String RS_SERVICE_PACKAGE = "org.knime.core.jaxrs.workflow.service";

    private RSServiceMap() {
     ...
     */
    public static RSServiceMap getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new RSServiceMap();
        }
        return INSTANCE;
    }
