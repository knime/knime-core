 ...
 */
public class NodeOutPortEntToRS {

	private final NodeOutPortEnt m_e;
	
	public NodeOutPortEntToRS(final NodeOutPortEnt e) {
		m_e = e;
	}
    ...
    public PortTypeEntToRS getPortType() {
            return new PortTypeEntToRS(m_e.getPortType());
        }
