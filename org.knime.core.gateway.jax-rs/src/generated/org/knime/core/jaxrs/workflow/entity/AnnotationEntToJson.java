...
/**
 * Wrapper class for the {@link AnnotationEnt} interface with Json-annotated getter-methods.
 *
...
public class AnnotationEntToJson  implements AnnotationEnt {
	...
	public AnnotationEntToJson(final AnnotationEnt e) {
		m_e = e;
	}
	...
	public static AnnotationEnt wrap(AnnotationEnt e) {
	    if(e instanceof WorkflowAnnotationEnt) {
	        return WorkflowAnnotationEntToJson.wrap((WorkflowAnnotationEnt) e);
	    }
