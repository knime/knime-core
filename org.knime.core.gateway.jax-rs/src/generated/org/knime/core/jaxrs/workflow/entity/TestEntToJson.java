...
public class TestEntToJson {
	...
	@JsonProperty("xy")
    public XYEntToJson getxy() {
            return new XYEntToJson(m_e.getxy());
        }
    
	@JsonProperty("xylist")
    public List<XYEntToJson> getxylist() {
	...
	@JsonProperty("xymap")
    public Map<String, XYEntToJson> getxymap() {
        	//TODO support non-primitive map-keys
    	Map<String, XYEntToJson> res = new HashMap<>();
