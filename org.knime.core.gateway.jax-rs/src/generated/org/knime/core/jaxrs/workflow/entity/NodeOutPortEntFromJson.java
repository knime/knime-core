...
/**
 * Implementation of the {@link NodeOutPortEnt} interface that can be deserialized from a json object (json-annotated constructor).
 *
...
public class NodeOutPortEntFromJson extends NodePortEntFromJson implements NodeOutPortEnt {
	...
	@JsonCreator
	private NodeOutPortEntFromJson(
	...
	protected NodeOutPortEntFromJson() {
