...
/**
 * Wrapper class for the {@link RepoCategoryEnt} interface with Json-annotated getter-methods.
 *
 * @author Martin Horn, University of Konstanz
 */
public class RepoCategoryEntToJson {

	private final RepoCategoryEnt m_e;
	
	public RepoCategoryEntToJson(final RepoCategoryEnt e) {
		m_e = e;
	}
    ...
    public List<RepoCategoryEntToJson> getCategories() {
        	return m_e.getCategories().stream().map(l -> new RepoCategoryEntToJson(l)).collect(Collectors.toList());
        }
    
	@JsonProperty("Nodes")
    public List<RepoNodeTemplateEntToJson> getNodes() {
