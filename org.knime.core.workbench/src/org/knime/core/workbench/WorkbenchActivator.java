...
public final class WorkbenchActivator implements BundleActivator {
     ...
     */
    public Optional<WorkbenchMountPointDefinition> getMountPointDefinition(final String typeIdentifier) {
        return Optional.ofNullable(m_mountPointDefinitionMap.get(typeIdentifier));
    }
