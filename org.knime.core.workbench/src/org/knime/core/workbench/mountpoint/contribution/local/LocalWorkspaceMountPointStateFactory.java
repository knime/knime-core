 ...
 */
public final class LocalWorkspaceMountPointStateFactory
implements WorkbenchMountPointStateFactory<LocalWorkspaceMountPointState> {
    ...
    public LocalWorkspaceMountPointState newInstance(final MountSettings settings) {
        return LocalWorkspaceMountPointState.INSTANCE;
    }
}
