 ...
 */
public final class TempSpaceMountPointSettingsHandler extends NoopMountPointSettingsHandler {

    /**
     * The id of this predefined and always existing content provider.
     */
    public static final String ID = WorkbenchConstants.TYPE_IDENTIFIER_TEMP_SPACE;
}
