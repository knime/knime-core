...
/**
 * A couple unit tests for the RetriggerableDelayedRunnable class.
 *
 * @author loki der quaeler
 */
public class RetriggerableDelayedRunnableTest extends TestCase {
    /**
     * Tests the case of a successful re-triggering.
     */
    ...
    /**
     * Tests the case of a late re-triggering (occurs after the trigger has fired.)
     */
