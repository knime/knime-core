...
public class WizardNodeFactory extends NodeFactory<WizardNodeModel>
     ...
     */
    @Override
    public WizardNodeModel createNodeModel() {
        return new WizardNodeModel();
    }
     ...
     */
    @Override
    public NodeView<WizardNodeModel> createNodeView(final int viewIndex, final WizardNodeModel nodeModel) {
        return null;
    }
