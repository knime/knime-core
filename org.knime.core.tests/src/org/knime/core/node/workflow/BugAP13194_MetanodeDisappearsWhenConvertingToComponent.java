 ...
 */
public class BugAP13194_MetanodeDisappearsWhenConvertingToComponent extends WorkflowTestCase {
    ...
    /** Converts metanode (with a wfm-through-connection) to component.
     * @throws Exception */
    @Test
    public void testConvertToComponent() throws Exception {
