...
/**
 * Unit tests for {@link BooleanType}.
 *
...
public class BooleanTypeTest extends AbstractSimpleVariableTypeTest<Boolean> {
    ...
    public BooleanTypeTest() {
        super(SharedIcons.FLOWVAR_BOOLEAN.get(), Boolean.class, BooleanType.INSTANCE, OVERWRITABLE, CREATION_COMPATIBLE,
            Sets.newHashSet(BooleanType.INSTANCE, BooleanArrayType.INSTANCE, StringType.INSTANCE,
    ...
    public void testLoadValue() throws InvalidSettingsException {
        when(readSettings.getBoolean(CFG_VALUE)).thenReturn(Boolean.TRUE);
        assertTrue(BooleanType.INSTANCE.loadValue(readSettings).get());
    }

    @Override
    @Test
    public void testSaveValue() {
        BooleanType.INSTANCE.saveValue(writeSettings, BooleanType.INSTANCE.newValue(true));
        verify(writeSettings).addBoolean(CFG_VALUE, true);
    }
