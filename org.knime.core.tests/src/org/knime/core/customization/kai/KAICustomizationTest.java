 ...
 *
 * History
 *   Jun 8, 2024 (Adrian Nembach, KNIME GmbH, Konstanz, Germany): created
 */
...
/**
 * Tests for {@link KAICustomization}.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
@SuppressWarnings("static-method")
final class KAICustomizationTest {
    ...
    void testDefaultName() throws Exception {
        ...
        var customization = mapper.readValue(ymlInput, KAICustomization.class);
        assertNotNull(customization);
        assertEquals(true, customization.suggestExtensions());
    }
}
