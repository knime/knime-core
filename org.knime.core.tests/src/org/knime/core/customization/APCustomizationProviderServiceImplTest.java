...
public class APCustomizationProviderServiceImplTest {
    ...
    void testGetCustomization() {
        ...
        NodesCustomization nodesCustomization = customization.getNodesCustomization().get(0);
        // can't check internals because class have package scope
        assertThat("debug description of customization", nodesCustomization.toString(), containsString("WHITELIST"));
        assertThat("debug description of customization", nodesCustomization.toString(), containsString("VIEW"));
        assertThat("debug description of customization", nodesCustomization.toString(),
