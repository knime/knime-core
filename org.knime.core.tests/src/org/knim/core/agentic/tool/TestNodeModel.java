...
class TestNodeModel extends NodeModel {
    ...
    private BufferedDataTable m_outData;

    protected TestNodeModel(final BufferedDataTable outData) {
        super(1, 1);
        m_outData = outData;
    }
    ...
    protected TestNodeModel(final PortType[] inPorts, final PortType[] outPorts) {
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
        if (m_outData != null) {
            return new DataTableSpec[]{m_outData.getDataTableSpec()};
        }
        return inSpecs;
    }
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
        throws Exception {
        if (m_outData != null) {
            return new BufferedDataTable[]{m_outData};
        }
        return inData;
    }
