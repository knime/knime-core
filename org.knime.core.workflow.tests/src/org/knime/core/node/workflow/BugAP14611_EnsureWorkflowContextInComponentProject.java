...
/**
 * Tests to ensure that components opened as project provide a workflow context.
 *
...
public class BugAP14611_EnsureWorkflowContextInComponentProject extends WorkflowTestCase {
	...
	private WorkflowLoadResult initWorkflowFromTemp() throws Exception {
		...
		m_component_2 = new NodeID(baseID, 2);
		return loadResult;
	}

	/**
	 * Saves a component and opens it as component project in order to make sure
	 * that the workflow context is available.
	 *
	 * @throws Exception
	 */
	@Test
