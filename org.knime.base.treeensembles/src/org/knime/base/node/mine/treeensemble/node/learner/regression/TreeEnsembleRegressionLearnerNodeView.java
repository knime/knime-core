 ...
 * @author Heiko Hofer
 */
final class TreeEnsembleRegressionLearnerNodeView extends
        NodeView<TreeEnsembleRegressionLearnerNodeModel> implements HiLiteListener {

    /** The node logger for this class. */
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(TreeEnsembleRegressionLearnerNodeView.class);
