...
class TreeEnsembleShrinkerNodeModel extends NodeModel {
    ...
    protected TreeEnsembleShrinkerNodeModel() {
        super(new PortType[]{TreeEnsembleModelPortObject.TYPE, BufferedDataTable.TYPE}, new PortType[]{PMMLPortObject.TYPE});
    }
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        if (shrink) {
            ...
            resultEnsemble =
                new TreeEnsembleModelPortObject(((TreeEnsembleModelPortObject)inObjects[0]).getSpec(), newEnsemble);
        } else {
